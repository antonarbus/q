  !function(e, t) {
          ...
          if ("Element"in e) {
              ...
              o.defineProperty) {
                  ...
                  try {
                      ...
                      void 0 !== h.number && -2146823252 !== h.number || (p.enumerable = !1,
                      o.defineProperty(r, t, p))
                  }
              } else
                  o[n].__defineGetter__ && r.__defineGetter__(t, f)
          }
      }(self),
      function() {
          ...
          !e.classList.contains("c2")) {
              var t = function zc(e) {
                  var zc = DOMTokenList.prototype[e];
      ...
      function() {
          var e, t = -1;
          if ("Microsoft Internet Explorer" === navigator.appName ? (e = navigator.userAgent,
          ...
          !("undefined" == typeof window || "undefined" == typeof document || "undefined" == typeof HTMLElement || t < 0)) {
              var n = !1;
              try {
                  ...
                  r.focus(Object.defineProperty({}, "preventScroll", {
                      get: function() {
              ...
              if (HTMLElement.prototype.nativeFocus === undefined && !n) {
                  ...
                  var o = function o(e) {
                      for (var t = e.parentNode, n = [], r = document.scrollingElement || document.documentElement; t && t !== r; )
                          (t.offsetHeight < t.scrollHeight || t.offsetWidth < t.scrollWidth) && n.push([t, t.scrollTop, t.scrollLeft]),
                          t = t.parentNode;
                      return t = r,
                    ...
                    , i = function i(e) {
                      for (var t = 0; t < e.length; t++)
                          e[t][0].scrollTop = e[t][1],
                          e[t][0].scrollLeft = e[t][2];
                      e = []
                  }
                    , a = function a(e) {
      ...
      V.MODULES.node = function(a) {
          ...
          function t(e) {
              for (var t = "", n = c(e), r = Object.keys(n), o = 0; o < r.length; o++) {
                  var i = r[o]
                    , a = n[i];
      ...
      V.MODULES.clean = function(C) {
          ...
          function o(e) {
              ...
              for (t = 0; t < n.length; t++)
                  n[t].nodeType !== Node.ELEMENT_NODE || C.node.isVoid(n[t]) ? n[t].nodeType === Node.TEXT_NODE && (n[t].textContent = n[t].textContent.replace(/\u200b/g, "")) : n[t].textContent.replace(/\u200b/g, "").length !== n[t].textContent.length && o(n[t]);
          ...
          function c(e) {
              ...
              for (t in e)
                  if (Object.prototype.hasOwnProperty.call(e, t)) {
                      var n = t.match(b)
                        , r = null;
                      "style" === t && C.opts.htmlAllowedStyleProps.length && (r = e[t].match(L)),
                      n && r ? e[t] = E(r.join(";")) : n && ("style" !== t || r) || delete e[t]
                  }
          ...
          function p(e, t, n) {
              var r = e = function i(e) {
                ...
                , o = null;
              return C.opts.fullPage && (r = C.html.extractNode(e, "body") || (0 <= e.indexOf("<body") ? "" : e),
              n && (o = C.html.extractNode(e, "head") || "")),
              r = d(r, t),
              o && (o = d(o, t)),
              function a(e) {
                  return e = (e = (e = e.replace(/\[FROALA\.EDITOR\.SCRIPT ([\d]*)\]/gi, function(e, t) {
                      return 0 <= C.opts.htmlRemoveTags.indexOf("script") ? "" : l[parseInt(t, 10)]
                  })).replace(/\[FROALA\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function(e, t) {
                      if (0 <= C.opts.htmlRemoveTags.indexOf("noscript"))
                          return "";
                  ...
                  if (C.opts.fullPage) {
                      var r = C.html.extractDoctype(n)
                        , o = c(C.html.extractNodeAttrs(n, "html"));
                      t = null === t ? C.html.extractNode(n, "head") || "<title></title>" : t;
                      var i = c(C.html.extractNodeAttrs(n, "head"))
                        , a = c(C.html.extractNodeAttrs(n, "body"));
          ...
          function h(e) {
              for (var t = C.node.contents(e), n = 0; n < t.length; n++)
                  t[n].nodeType !== Node.TEXT_NODE && h(t[n]);
              !function g(n) {
                  if ("SPAN" === n.tagName && 0 <= (n.getAttribute("class") || "").indexOf("fr-marker"))
                      return !1;
                  if ("PRE" === n.tagName && function u(e) {
                      var t = e.innerHTML;
                      0 <= t.indexOf("\n") && (e.innerHTML = t.replace(/\n/g, "<br>"))
                  }(n),
                  n.nodeType === Node.ELEMENT_NODE && (n.getAttribute("data-fr-src") && 0 !== n.getAttribute("data-fr-src").indexOf("blob:") && n.setAttribute("data-fr-src", C.helpers.sanitizeURL(y(n.getAttribute("data-fr-src")))),
                  n.getAttribute("href") && n.setAttribute("href", C.helpers.sanitizeURL(y(n.getAttribute("href")))),
                  n.getAttribute("src") && n.setAttribute("src", C.helpers.sanitizeURL(y(n.getAttribute("src")))),
                  n.getAttribute("srcdoc") && n.setAttribute("srcdoc", C.clean.html(n.getAttribute("srcdoc"))),
                  0 <= ["TABLE", "TBODY", "TFOOT", "TR"].indexOf(n.tagName) && (n.innerHTML = n.innerHTML.trim())),
                  !C.opts.pasteAllowLocalImages && n.nodeType === Node.ELEMENT_NODE && "IMG" === n.tagName && n.getAttribute("data-fr-src") && 0 === n.getAttribute("data-fr-src").indexOf("file://"))
                      return n.parentNode.removeChild(n),
                      !1;
                  if (n.nodeType === Node.ELEMENT_NODE && V.HTML5Map[n.tagName] && "" === C.node.attributes(n)) {
                      var e = V.HTML5Map[n.tagName]
                        , t = "<".concat(e, ">").concat(n.innerHTML, "</").concat(e, ">");
                      n.insertAdjacentHTML("beforebegin", t),
                      (n = n.previousSibling).parentNode.removeChild(n.nextSibling)
                  }
                  if (C.opts.htmlAllowComments || n.nodeType !== Node.COMMENT_NODE)
                      if (n.tagName && n.tagName.match(v)) {
                          if ("STYLE" == n.tagName && C.helpers.isMac()) {
                              var r, o = n.innerHTML.trim(), i = [], a = /{([^}]+)}/g;
                              for (o = o.replace(/\/\*[\s\S]*?\*\/|([^\\:]|^)\/\/.*|<!--[\s\S]*?-->$/, ""); r = a.exec(o); )
                                  i.push(r[1]);
                              for (var s = function s(t) {
                                  var e = o.substring(0, o.indexOf("{")).trim();
                                  0 == !/^[a-z_-][a-z\d_-]*$/i.test(e) && n.parentNode.querySelectorAll(e).forEach(function(e) {
                      ...
                      } else if (n.tagName && !n.tagName.match(m))
                          "svg" === n.tagName ? n.parentNode.removeChild(n) : C.browser.safari && "path" === n.tagName && n.parentNode && "svg" === n.parentNode.tagName || (n.outerHTML = n.innerHTML);
                      else {
                          var c = n.attributes;
                          if (c)
                              for (var d = c.length - 1; 0 <= d; d--) {
                                  var f = c[d]
                                    , p = f.nodeName.match(b)
                                    , h = null;
                                  "style" === f.nodeName && C.opts.htmlAllowedStyleProps.length && (h = f.value.match(L)),
                                  p && h ? f.value = E(h.join(";")) : p && ("style" !== f.nodeName || h) || n.removeAttribute(f.nodeName)
                              }
                      }
                  else
                      0 !== n.data.indexOf("[FROALA.EDITOR") && n.parentNode.removeChild(n)
              }(e)
          }
          return {
              _init: function e() {
                  C.opts.fullPage && f.merge(C.opts.htmlAllowedTags, ["head", "title", "style", "link", "base", "body", "html", "meta"])
              },
              html: function u(e, t, n, r) {
                  void 0 === t && (t = []),
                  void 0 === n && (n = []),
                  void 0 === r && (r = !1);
                  var o, i = f.merge([], C.opts.htmlAllowedTags);
                  for (o = 0; o < t.length; o++)
                      0 <= i.indexOf(t[o]) && i.splice(i.indexOf(t[o]), 1);
                  var a = f.merge([], C.opts.htmlAllowedAttrs);
                  for (o = 0; o < n.length; o++)
                      0 <= a.indexOf(n[o]) && a.splice(a.indexOf(n[o]), 1);
                  return a.push("data-fr-.*"),
                  a.push("fr-.*"),
                  m = new RegExp("^".concat(i.join("$|^"), "$"),"gi"),
                  b = new RegExp("^".concat(a.join("$|^"), "$"),"gi"),
                  v = new RegExp("^".concat(C.opts.htmlRemoveTags.join("$|^"), "$"),"gi"),
                  L = C.opts.htmlAllowedStyleProps.length ? new RegExp("((^|;|\\s)".concat(C.opts.htmlAllowedStyleProps.join(":.+?(?=;|$))|((^|;|\\s)"), ":.+?(?=(;)|$))"),"gi") : null,
                  e = p(e, h, !0),
                  "undefined" != typeof C.opts.DOMPurify && (e = C.opts.DOMPurify.sanitize(e, {
                      ADD_TAGS: C.opts.htmlAllowedTags,
                      ALLOW_UNKNOWN_PROTOCOLS: !0
                  })),
                  e
              },
              toHTML5: function r() {
                  var e = C.el.querySelectorAll(Object.keys(V.HTML5Map).join(","));
                  if (e.length) {
                      var t = !1;
                      C.el.querySelector(".fr-marker") || (C.selection.save(),
                      t = !0);
                      for (var n = 0; n < e.length; n++)
                          "" === C.node.attributes(e[n]) && f(e[n]).replaceWith("<".concat(V.HTML5Map[e[n].tagName], ">").concat(e[n].innerHTML, "</").concat(V.HTML5Map[e[n].tagName], ">"));
                      t && C.selection.restore()
                  }
              },
              tables: function t() {
                  !function c() {
                      for (var e = C.el.querySelectorAll("tr"), t = 0, n = 0; n < e.length; n++) {
                          var r = e[n].outerHTML.match(/rowspan="([0-9]+)"/);
                          r && (t += Number(r[1]) - 1);
                          for (var o = e[n].children, i = !0, a = 0; a < o.length; a++)
                              if ("TH" !== o[a].tagName) {
                                  i = !1;
                                  break
                              }
                          if (!1 !== i && 0 !== o.length) {
                              var s = e[n];
                              if (1 === o.length && "TH" === o[0].tagName && t)
                                  t--;
                              else {
                                  for (; s && "TABLE" !== s.tagName && "THEAD" !== s.tagName; )
                                      s = s.parentNode;
                                  var l = s;
                                  l.firstChild.nodeType === Node.ELEMENT_NODE && "THEAD" === l.firstChild.tagName ? l = l.firstChild : "THEAD" !== l.tagName && (l = C.doc.createElement("THEAD"),
              ...
              lists: function g() {
                  !function s() {
                      ...
                      do {
                          ...
                          t = [];
                          for (var i = C.el.querySelectorAll("li"), a = 0; a < i.length; a++)
                              e = i[a],
                              C.node.isList(e.parentNode) || t.push(i[a])
                      } while (0 < t.length)
                  }(),
                  function i() {
                      for (var e = C.el.querySelectorAll("ol + ol, ul + ul"), t = 0; t < e.length; t++) {
                          ...
                          if (C.node.isList(n.previousSibling) && C.node.openTagString(n) === C.node.openTagString(n.previousSibling)) {
                              for (var r = C.node.contents(n), o = 0; o < r.length; o++)
                  ...
                  function a() {
                      for (var e = C.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++)
                          for (var n = C.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--)
                              !n[o].tagName && C.opts.htmlUntouched || "LI" === n[o].tagName || "UL" == n[o].tagName || "OL" == n[o].tagName ? r = null : "BR" == n[o].tagName ? f(n[o]).remove() : (r || (r = f(C.doc.createElement("LI"))).insertBefore(n[o]),
                              r.prepend(n[o]))
                  }(),
                  function l() {
                      var e, t, n;
                  ...
                  function o() {
                      for (var e = C.el.querySelectorAll("ul > ul, ol > ol, ul > ol, ol > ul"), t = 0; t < e.length; t++) {
                          var n = e[t]
                            , r = n.previousSibling;
                          r && ("LI" === r.tagName ? r.appendChild(n) : f(n).wrap("<li></li>"))
                      }
                  }(),
                  function c() {
                  ...
                  function d() {
                      for (var e = C.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                          var n = e[t];
                          if (C.node.isFirstSibling(n) && "none" != n.parentNode.style.listStyleType)
                              f(n).before("<br/>");
                              ...
                              for (var r = n.previousSibling.previousSibling; r && C.node.hasClass(r, "fr-marker"); )
                                  r = r.previousSibling;
                              r && "BR" !== r.tagName && f(n.previousSibling).remove()
                          }
                      }
                  }(),
                  function n() {
      ...
      V.MODULES.helpers = function(i) {
          ...
          function t() {
              return (/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || function e() {
          ...
          return {
              ...
              getIOSVersion: function f() {
                  if (t()) {
                      var e = navigator.userAgent.match(/OS (\d)?\d_\d(_\d)?/i) || navigator.userAgent.match(/\b[0-9]+_[0-9]+(?:_[0-9]+)?\b/);
                      return e && e.length && Math.abs(e[0].split("_")[0].replace("OS ", "")) || NaN
                  }
                  return NaN
              },
              isAndroid: n,
              ...
              screenSize: function C(e) {
                  try {
                      var t = 0;
                      if ((t = e ? i.$box.width() : i.$sc.width()) < 768)
                          return V.XS;
                      if (768 <= t && t < 992)
                          return V.SM;
                      if (992 <= t && t < 1200)
              ...
              sanitizeURL: function v(e) {
                  return i.opts.DOMPurify && (e = i.opts.DOMPurify.sanitize(e, {
                      ADD_TAGS: i.opts.htmlAllowedTags,
                      ALLOW_UNKNOWN_PROTOCOLS: !0,
                      ALLOWED_URI_REGEXP: /^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp|xxx):|[^a-z]|[a-z+.]+(?:[^a-z+.\-:]|$))/i
                  })),
                  e = e.replace(/\son\w+='[^']*'/g, ""),
                  /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(".concat(V.LinkProtocols.join("|"), "):"),"i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}").replace(/%[0-1]+[0-9]+|%[0-1]+[A-F]+/g, "")
              },
              isArray: function b(e) {
                  return e && !Object.prototype.propertyIsEnumerable.call(e, "length") && "object" === A(e) && "number" == typeof e.length
              },
              RGBToHex: function L(e) {
                  function t(e) {
      ...
      V.MODULES.events = function(l) {
          ...
          return {
              _init: function L() {
                  ...
                  function i() {
                      s(l.$el, "focus", function(e) {
                          h() && (c(!1),
                          !1 === d && (m(e.type, [e]),
                          l.helpers.isMobile() && p()))
                      }),
                      s(l.$el, "blur", function(e) {
                          h() && !0 === d && (m(e.type, [e]),
                          l.helpers.isMobile() && l.opts.toolbarContainer && (l.shared.selected_editor = l.id),
                          f())
                      }),
              ...
              bindClick: function r(e, t, n) {
                  ...
                  C(e, "".concat(l._mouseup, " ").concat(l._move), t, function(e) {
                  ...
                  C(e, "mousedown click mouseup", t, function(e) {
      ...
      V.MODULES.commands = function(a) {
          ...
          var i = {
              ...
              insertHR: function() {
                  ...
                  r.prev().is("hr") ? n = a.selection.setAfter(r.get(0), !1) : r.next().is("hr") ? n = a.selection.setBefore(r.get(0), !1) : o || a.selection.setAfter(r.get(0), !1) ? a.selection.setAfter(r[0].parentNode, !1) : a.selection.setBefore(r.get(0), !1),
                  n || void 0 === n || (e = l(e = "".concat(V.MARKERS, "<br>")),
                  r.after(e)),
                  a.selection.restore()
              },
          ...
          function t(e) {
              ...
              a.opts.trackChangesEnabled || a.markdown && a.markdown.isEnabled() ? n && n.addClass("fr-disabled") : n && n.removeClass("fr-disabled"),
              function r(n) {
                  ...
                  "trackChanges" === n.data("cmd") && (e = a.$tb.find('.fr-more-toolbar[data-name="'.concat(n.attr("id"), '"]')));
                  if (a.$tb.find(".fr-open").not(n).not('[data-cmd="trackChanges"]').removeClass("fr-open"),
                  n.toggleClass("fr-open"),
                  a.$tb.find(".fr-more-toolbar").removeClass("fr-overflow-visible"),
                  a.$tb.find(".fr-expanded").not(e).length) {
          ...
          function n(e, t) {
              if (!(a.markdown && a.markdown.isEnabled() && ("bold" === e || "italic" === e || "underline" === e) || a.opts.trackChangesEnabled && "markdown" === e) && !1 !== a.events.trigger("commands.before", s.merge([e], t || []))) {
                  ...
                  (!a.core.hasFocus() && r || !a.core.hasFocus() && o && a.accessibility.hasFocus()) && (a.el.focus({
                      preventScroll: !0
                  }),
                  a.events.trigger("focus")),
          ...
          function r(e) {
              ...
              for (var t = a.selection.blocks(), n = 0; n < t.length; n++)
                  if ("LI" !== t[n].tagName && "LI" != t[n].parentNode.tagName && ("LI" !== t[n].tagName || "LI" !== t[n].parentNode.tagName)) {
                      var r = s(t[n]);
          ...
          var c = {};
          for (var d in i)
              Object.prototype.hasOwnProperty.call(i, d) && (c[d] = o(d));
      ...
      ,
      V.MODULES.cursorLists = function(v) {
          var b = v.$;
          function L(e) {
          ...
          return {
              _startEnter: function S(e) {
                  var t, n = L(e), r = n.nextSibling, o = n.previousSibling, i = v.html.defaultTag();
                  if (v.node.isEmpty(n, !0) && r) {
                      for (var a = "", s = "", l = e.parentNode; !v.node.isList(l) && l.parentNode && ("LI" !== l.parentNode.tagName || l.parentNode === n); )
                          -1 < ["OL", "LI", "UL"].indexOf(l.tagName) && (a = v.node.openTagString(l) + a,
                          s += v.node.closeTagString(l)),
                          l = l.parentNode;
                      a = v.node.openTagString(l) + a,
                      s += v.node.closeTagString(l);
                      var c = "";
                      if (l.parentNode && "LI" === l.parentNode.tagName)
                          if (l.parentNode.attributes.length) {
                              var d = y(l.parentNode.attributes);
                              c = "".concat(s, "<li ").concat(d, ">").concat(V.MARKERS, "<br>").concat(a)
                          } else
                              c = "".concat(s, "<li>").concat(V.MARKERS, "<br>").concat(a);
                      else
                          c = i ? "".concat(s, "<").concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">").concat(a) : "".concat(s + V.MARKERS, "<br>").concat(a);
                      for (; ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName; )
                          l = l.parentNode;
                      b(n).replaceWith('<span id="fr-break"></span>');
                      var f = v.node.openTagString(l) + b(l).html() + v.node.closeTagString(l);
                      f = f.replace(/<span id="fr-break"><\/span>/g, c),
                      b(l).replaceWith(f),
                      v.$el.find("li:empty").remove(),
                      v.$el.find("li > p > span:empty").length && v.$el.find("li > p > span:empty")[0].parentNode.parentNode.remove()
                  } else if (o && r || !v.node.isEmpty(n, !0)) {
                      var p = "<br>"
                        , h = e.parentNode;
                      for (h && "A" === h.tagName && (h = null); h && "LI" !== h.tagName; )
                          p = v.node.openTagString(h) + p + v.node.closeTagString(h),
                          h = h.parentNode;
                      if (h && h.attributes.length) {
                          var u = y(h.attributes);
                          b(n).before("<li ".concat(u, ">").concat(p, "</li>"))
                      } else
                          b(n).before("<li>".concat(p, "</li>"));
                      b(e).remove()
                  } else if (o) {
                      t = E(n);
                      for (var g = "".concat(V.MARKERS, "<br>"), C = e.parentNode; C && "LI" !== C.tagName; )
                          g = v.node.openTagString(C) + g + v.node.closeTagString(C),
                          C = C.parentNode;
                      if (t.parentNode && "LI" === t.parentNode.tagName)
                          if (t.parentNode.attributes.length) {
                              var m = y(t.parentNode.attributes);
                              b(t.parentNode).after("<li ".concat(m, ">").concat(g, "</li>"))
                          } else
                              b(t.parentNode).after("<li>".concat(g, "</li>"));
                      else
                          i ? b(t).after("<".concat(i, ">").concat(g, "</").concat(i, ">")) : b(t).after(g);
                      b(n).remove()
                  } else
                      (t = E(n)).parentNode && "LI" === t.parentNode.tagName ? r ? b(t.parentNode).before("".concat(v.node.openTagString(n) + V.MARKERS, "<br></li>")) : b(t.parentNode).after("".concat(v.node.openTagString(n) + V.MARKERS, "<br></li>")) : i ? b(t).before("<".concat(i, ">").concat(V.MARKERS, "<br></").concat(i, ">")) : b(t).before("".concat(V.MARKERS, "<br>")),
                      b(n).remove()
              },
              _middleEnter: function c(e) {
                  for (var t = L(e), n = "", r = e, o = "", i = "", a = !1; r !== t; ) {
                      var s = "A" === (r = r.parentNode).tagName && v.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
                      a || r == t || v.node.isBlock(r) || (a = !0,
                      o += V.INVISIBLE_SPACE),
                      o = v.node.openTagString(b(r).clone().addClass(s).get(0)) + o,
                      i += v.node.closeTagString(r)
                  }
                  n = i + n + o + V.MARKERS + (v.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : ""),
                  b(e).replaceWith('<span id="fr-break"></span>');
                  var l = v.node.openTagString(t) + b(t).html() + v.node.closeTagString(t);
                  l = l.replace(/<span id="fr-break"><\/span>/g, n),
                  b(t).replaceWith(l)
              },
              _endEnter: function l(e) {
                  for (var t = L(e), n = V.MARKERS, r = "", o = e, i = !1; o !== t; )
                      if (!(o = o.parentNode).classList.contains("fr-img-space-wrap") && !o.classList.contains("fr-img-space-wrap2")) {
                          var a = "A" === o.tagName && v.cursor.isAtEnd(e, o) ? "fr-to-remove" : "";
                          i || o === t || v.node.isBlock(o) || (i = !0,
                          r += V.INVISIBLE_SPACE),
                          r = v.node.openTagString(b(o).clone().addClass(a).get(0)) + r,
                          n += v.node.closeTagString(o)
                      }
                  var s = r + n;
                  b(e).remove(),
                  b(t).after(s)
              ...
              _backspace: function d(e) {
                  var t = L(e)
                    , n = t.previousSibling;
                  if (n) {
                      n = b(n).find(v.html.blockTagsQuery()).get(-1) || n,
                      b(e).replaceWith(V.MARKERS);
                      var r = v.node.contents(n);
                      r.length && "BR" === r[r.length - 1].tagName && b(r[r.length - 1]).remove(),
                      b(t).find(v.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                          this.parentNode === t && b(this).replaceWith(b(this).html() + (v.node.isEmpty(this) ? "" : "<br>"))
                      });
                      for (var o, i = v.node.contents(t)[0]; i && !v.node.isList(i); )
                          o = i.nextSibling,
                          b(n).append(i),
                          i = o;
                      for (n = t.previousSibling; i; )
                          ...
                          b(n).append(i),
                          i = o;
                      1 < (r = v.node.contents(n)).length && "BR" === r[r.length - 1].tagName && b(r[r.length - 1]).remove(),
                      b(t).remove()
                  } else {
                      var a = E(t);
                      if (b(e).replaceWith(V.MARKERS),
                      a.parentNode && "LI" === a.parentNode.tagName) {
                          var s = a.previousSibling;
                          v.node.isBlock(s) ? (b(t).find(v.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                              this.parentNode === t && b(this).replaceWith(b(this).html() + (v.node.isEmpty(this) ? "" : "<br>"))
                          }),
                          b(s).append(b(t).html())) : b(a).before(b(t).html())
                      } else {
                          var l = v.html.defaultTag();
                          l && 0 === b(t).find(v.html.blockTagsQuery()).length ? b(a).before("<".concat(l, ">").concat(b(t).html(), "</").concat(l, ">")) : b(a).before(b(t).html())
                      }
                      b(t).remove(),
                      v.html.wrap(),
                      0 === b(a).find("li").length && b(a).remove()
                  }
              },
              _del: function f(e) {
                  var t, n = L(e), r = n.nextSibling;
                  if (r) {
                      (t = v.node.contents(r)).length && "BR" === t[0].tagName && b(t[0]).remove(),
                      b(r).find(v.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                          this.parentNode === r && b(this).replaceWith(b(this).html() + (v.node.isEmpty(this) ? "" : "<br>"))
                      });
                      for (var o, i = e, a = v.node.contents(r)[0]; a && !v.node.isList(a); )
                          o = a.nextSibling,
                          b(i).after(a),
                          i = a,
                          a = o;
                      ...
                      for (var s = n; !s.nextSibling && s !== v.el; )
                          s = s.parentNode;
                      if (s === v.el)
                          return !1;
                      if (s = s.nextSibling,
                      v.node.isBlock(s)) {
                          if (V.NO_DELETE_TAGS.indexOf(s.tagName) < 0) {
                              if (b(e).replaceWith(V.MARKERS),
                              (t = v.node.contents(n)).length && "BR" === t[t.length - 1].tagName && b(t[t.length - 1]).remove(),
                              s.isContentEditable && "DIV" === s.tagName && (!v.node.isBlock(s.previousSibling) || "DIV" === s.previousSibling.tagName))
                                  return;
                              b(n).append(b(s).html()),
                              b(s).remove()
                          }
                      } else {
                          for ((t = v.node.contents(n)).length && "BR" === t[t.length - 1].tagName && b(t[t.length - 1]).remove(),
                          b(e).replaceWith(V.MARKERS); s && !v.node.isBlock(s) && "BR" !== s.tagName; )
                              b(n).append(b(s)),
                              s = s.nextSibling;
                          b(s).remove()
                      }
      ...
      V.MODULES.cursor = function(g) {
          ...
          function E(e) {
              ...
              if ((!g.node.isBlock(n) || n.lastChild && o && 0 <= r.indexOf(o)) && g.node.isEditable(n)) {
                  for (t = g.node.contents(n); n.nodeType !== Node.TEXT_NODE && !g.node.isDeletable(n) && t.length && g.node.isEditable(n); )
                      n = t[t.length - 1],
                      t = g.node.contents(n);
                  if (n.nodeType === Node.TEXT_NODE) {
                      var i = n.textContent
                        , a = i.length;
                      if (i.length && "\n" === i[i.length - 1])
                          return n.textContent = i.substring(0, a - 2),
                          0 === n.textContent.length && n.parentNode.removeChild(n),
                          E(e);
                      if (g.opts.tabSpaces && i.length >= g.opts.tabSpaces)
                          0 === i.substr(i.length - g.opts.tabSpaces, i.length - 1).replace(/ /g, "").replace(new RegExp(V.UNICODE_NBSP,"g"), "").length && (a = i.length - g.opts.tabSpaces + 1);
                      n.textContent = i.substring(0, a - L(i));
                      var s = n.textContent;
                      (g.opts.enter === V.ENTER_BR && 0 < s.length && " " === s.charAt(s.length - 1) || 0 === s.length && e.previousSibling && 3 === e.previousSibling.nodeType && "TD" !== e.parentNode.tagName && "LI" !== e.parentNode.tagName && i !== String.fromCharCode(8203)) && (e.insertAdjacentHTML("beforebegin", V.INVISIBLE_SPACE),
                      n = n.nextSibling),
                      g.opts.trackChangesEnabled && 0 === n.textContent.length && C(n.parentElement).data("tracking") && 0 === C(n.parentElement).find("[data-tracking-deleted=true]").length && (C(e).insertBefore(n.parentElement),
                      C(n.parentElement).remove(),
                      n = C(e)[0].previousSibling),
                      ...
                      if (g.opts.enter !== V.ENTER_BR && n && n.previousSibling && n.previousSibling.previousSibling && "BR" === n.previousSibling.previousSibling.tagName && 0 === n.textContent.length && n.previousSibling.previousSibling.remove(),
                      0 === n.textContent.length && "LI" === n.parentNode.tagName && n.previousSibling && "BR" === n.previousSibling.tagName && n.previousSibling.remove(),
                      0 === n.textContent.length)
                          if (l && g.opts.keepFormatOnDelete)
                              C(n).after(V.INVISIBLE_SPACE + V.MARKERS);
                          else if (0 !== i.length && g.node.isBlock(n.parentNode))
                              C(n).after(V.MARKERS);
                              ...
                              c || (n = d),
                              C(n).after(V.MARKERS),
                              g.node.isElement(n.parentNode) && !e.nextSibling && n.previousSibling && "BR" === n.previousSibling.tagName && C(e).after("<br>");
                              var p = n.parentNode;
                              n.parentNode.removeChild(n),
                              g.node.isEmpty(p) && C(p).html(V.INVISIBLE_SPACE + V.MARKERS)
                          } else
                              C(n.parentNode).after(V.MARKERS),
                              C(n.parentNode).remove();
                      else
                          C(n).after(V.MARKERS)
                  } else
                      g.node.isDeletable(n) ? (C(n).after(V.MARKERS),
                      C(n).remove()) : e.nextSibling && "BR" === e.nextSibling.tagName && g.node.isVoid(n) && "BR" !== n.tagName ? (C(e.nextSibling).remove(),
                      C(e).replaceWith(V.MARKERS)) : !1 !== g.events.trigger("node.remove", [C(n)]) && (C(n).after(V.MARKERS),
                      C(n).remove())
              } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (g.node.isEditable(n) || g.node.isDeletable(n)))
                  if (g.node.isDeletable(n))
                      C(e).replaceWith(V.MARKERS),
                      C(n).remove();
                  else if (g.node.isEmpty(n) && !g.node.isList(n))
                      C(n).remove(),
                      C(e).replaceWith(V.MARKERS);
                  else {
                      for (g.node.isList(n) && (n = C(n).find("li").last().get(0)),
                      (t = g.node.contents(n)) && 0 < t.length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(),
                      t = g.node.contents(n); t && 0 < t.length && g.node.isBlock(t[t.length - 1]); )
                          n = t[t.length - 1],
                          t = g.node.contents(n);
                      C(n).append(V.MARKERS);
                      for (var h = e; !h.previousSibling; )
                          h = h.parentNode;
                      ...
                      h && "BR" === h.tagName && C(h).remove(),
                      C(e).remove()
                  }
              else
                  e.nextSibling && "BR" === e.nextSibling.tagName && C(e.nextSibling).remove();
              return !0
          }
          function i(e) {
              ...
              if (null !== n) {
                  ...
                  if (g.node.isBlock(n) && (g.node.isEditable(n) || g.node.isDeletable(n)) && i && V.NO_DELETE_TAGS.indexOf(i.tagName) < 0)
                      if (g.node.isDeletable(i))
                          C(i).remove(),
                          C(e).replaceWith(V.MARKERS);
                      else if (g.node.isBlock(i) && g.node.isEditable(i))
                          if (g.node.isList(i))
                              if (g.node.isEmpty(n, !0))
                                  C(n).remove(),
                                  C(i).find("li").first().prepend(V.MARKERS);
                              else {
                                  var a = C(i).find("li").first();
                                  "BLOCKQUOTE" === n.tagName && (o = g.node.contents(n)).length && g.node.isBlock(o[o.length - 1]) && (n = o[o.length - 1]),
                                  0 === a.find("ul, ol").length && (C(e).replaceWith(V.MARKERS),
                                  a.find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                                      this.parentNode === a.get(0) && C(this).replaceWith(C(this).html() + (g.node.isEmpty(this) ? "" : "<br>"))
                                  }),
                                  C(n).append(g.node.contents(a.get(0))),
                                  a.remove(),
                                  0 === C(i).find("li").length && C(i).remove())
                              }
                          else {
                              if ((o = g.node.contents(i)).length && "BR" === o[0].tagName && C(o[0]).remove(),
                              "BLOCKQUOTE" !== i.tagName && "BLOCKQUOTE" === n.tagName)
                                  for (o = g.node.contents(n); o.length && g.node.isBlock(o[o.length - 1]); )
                                      n = o[o.length - 1],
                                      o = g.node.contents(n);
                              else if ("BLOCKQUOTE" === i.tagName && "BLOCKQUOTE" !== n.tagName)
                                  for (o = g.node.contents(i); o.length && g.node.isBlock(o[0]); )
                                      i = o[0],
                                      o = g.node.contents(i);
                              C(e).replaceWith(V.MARKERS),
                              C(n).append(i.innerHTML),
                              C(i).remove()
                          }
                      else {
                  ...
                  if (n.nextSibling) {
                      if (g.node.isBlock(n.nextSibling) && g.node.isEditable(n.nextSibling)) {
                          if (!(V.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0))
                              return void C(n).remove();
                          n = n.nextSibling,
                          C(n.previousSibling).remove()
                      }
                  } else if (h(n)) {
                      if (b(e))
                          g.cursorLists._del(e);
                      else
                          g.node.deepestParent(n) && ((!g.node.isEmpty(g.node.blockParent(n)) || (g.node.blockParent(n).nextSibling && V.NO_DELETE_TAGS.indexOf(g.node.blockParent(n).nextSibling.tagName)) < 0) && C(n).remove(),
                          n && n.parentNode && 8203 === n.parentNode.textContent.charCodeAt() && n.parentNode.childNodes[1] && "BR" === n.parentNode.childNodes[1].tagName && n.parentNode.tagName.toLowerCase() === g.html.defaultTag() && n.parentNode.nextSibling && "TABLE" === n.parentNode.nextSibling.tagName && C(n.parentNode).remove(),
                          i(e));
                      return
                  }
              if (!g.node.isBlock(n) && g.node.isEditable(n)) {
                  for (t = g.node.contents(n); n.nodeType !== Node.TEXT_NODE && t.length && !g.node.isDeletable(n) && g.node.isEditable(n); )
                      n = t[0],
                      t = g.node.contents(n);
                  n.nodeType === Node.TEXT_NODE ? (C(n).before(V.MARKERS),
                  n.textContent.length && (n.textContent = n.textContent.substring(L(n.textContent, !0), n.textContent.length))) : g.node.isDeletable(n) ? (C(n).before(V.MARKERS),
                  C(n).remove()) : !1 !== g.events.trigger("node.remove", [C(n)]) && (C(n).before(V.MARKERS),
                  C(n).remove()),
                  C(e).remove()
              } else if (V.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (g.node.isEditable(n) || g.node.isDeletable(n)))
                  if (g.node.isDeletable(n))
                      C(e).replaceWith(V.MARKERS),
                      C(n).remove();
                  else if (g.node.isList(n))
                      e.previousSibling ? (C(n).find("li").first().prepend(e),
                      g.cursorLists._backspace(e)) : (C(n).find("li").first().prepend(V.MARKERS),
                      C(e).remove());
                  else if ((t = g.node.contents(n)) && 0 < t.length && "BR" === t[0].tagName && C(t[0]).remove(),
                  t && 0 < t.length && "BLOCKQUOTE" === n.tagName) {
                      var r = t[0];
                      ...
                      C(e).after(C(n).html()).after(V.MARKERS),
                      C(n).remove()
          }
          function a() {
              for (var e = g.el.querySelectorAll("blockquote:empty"), t = 0; t < e.length; t++)
                  e[t].parentNode.removeChild(e[t])
          }
          function y(e, t, n) {
              var r, o = g.node.deepestParent(e, [], !n);
              if (o && "BLOCKQUOTE" === o.tagName)
                  return v(e, o) ? (r = g.html.defaultTag(),
                  t ? C(e).replaceWith("<br>" + V.MARKERS) : r ? C(o).after("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : C(o).after("".concat(V.MARKERS, "<br>")),
                  C(e).remove()) : S(e, t, n),
                  !1;
              if (null === o)
                  (r = g.html.defaultTag()) && g.node.isElement(e.parentNode) ? C(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || C(e.previousSibling).is("br") || e.nextSibling ? C(e).replaceWith("<br>".concat(V.MARKERS)) : C(e).replaceWith("<br>".concat(V.MARKERS, "<br>"));
              else {
                  var i = e
                    , a = "";
                  "PRE" != o.tagName || e.nextSibling || (t = !0),
                  g.node.isBlock(o) && !t || (a = "<br/>");
                  var s, l = "", c = "", d = "", f = "";
                  (r = g.html.defaultTag()) && g.node.isBlock(o) && (d = "<".concat(r, ">"),
                  f = "</".concat(r, ">"),
                  o.tagName === r.toUpperCase() && (d = g.node.openTagString(C(o).clone().removeAttr("id").get(0))));
                  do {
                      if (i = i.parentNode,
                      !t || i !== o || t && !g.node.isBlock(o))
                          if (l += g.node.closeTagString(i),
                          i === o && g.node.isBlock(o))
                              c = d + c;
                          else {
                  ...
                  a = l + a + c + (e.parentNode === o && g.node.isBlock(o) ? "" : V.INVISIBLE_SPACE) + V.MARKERS,
                  g.node.isBlock(o) && !C(o).find("*").last().is("br") && C(o).append("<br/>"),
                  C(e).after('<span id="fr-break"></span>'),
                  C(e).remove(),
                  o.nextSibling && !g.node.isBlock(o.nextSibling) || g.node.isBlock(o) || C(o).after("<br>"),
                  s = (s = !t && g.node.isBlock(o) ? g.node.openTagString(o) + C(o).html() + f : g.node.openTagString(o) + C(o).html() + g.node.closeTagString(o)).replace(/<span id="fr-break"><\/span>/g, a),
                  C(o).replaceWith(s)
              }
          }
          function S(e, t, n) {
              ...
              if (null === r)
                  g.html.defaultTag() && e.parentNode === g.el ? C(e).replaceWith("<".concat(g.html.defaultTag(), ">").concat(V.MARKERS, "<br></").concat(g.html.defaultTag(), ">")) : (e.nextSibling && !g.node.isBlock(e.nextSibling) || C(e).after("<br>"),
                  C(e).replaceWith("<br>".concat(V.MARKERS)));
              else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName)
                  C(e).replaceWith("<" + g.html.defaultTag() + ">" + V.MARKERS + "<br></" + g.html.defaultTag() + ">");
              else {
                  var o = e
                    , i = "";
                  "PRE" === r.tagName && (t = !0),
                  g.node.isBlock(r) && !t || (i = "<br>");
                  var a = ""
                    , s = "";
                  do {
                      var l = o;
                      if (o = o.parentNode,
                      "BLOCKQUOTE" === r.tagName && g.node.isEmpty(l) && !g.node.hasClass(l, "fr-marker") && C(l).contains(e) && C(l).after(e),
                      "BLOCKQUOTE" !== r.tagName || !v(e, o) && !m(e, o))
                          if (!t || o !== r || t && !g.node.isBlock(r)) {
                              a += g.node.closeTagString(o);
                              var c = "A" == o.tagName && v(e, o) || g.node.hasClass(o, "fa") ? "fr-to-remove" : "";
                              s = g.node.openTagString(C(o).clone().addClass(c).removeAttr("id").get(0)) + s,
                              g.opts.enter !== V.ENTER_DIV && o === r && "DIV" === r.tagName && (a = "<br>",
                              s = "")
                          } else
                  ...
                  if ("BLOCKQUOTE" === r.tagName)
                      if (e.previousSibling && g.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (C(e.nextSibling).after(e),
                      e.nextSibling && "BR" === e.nextSibling.tagName && C(e.nextSibling).remove()),
                      t)
                          i = a + i + V.MARKERS + s;
                      else {
          ...
          return {
              enter: function M(e) {
                  ...
                  for (var n = t.parentNode; n && !g.node.isElement(n); ) {
                      if ("false" === n.getAttribute("contenteditable"))
                          return C(t).replaceWith(V.MARKERS),
                          g.selection.restore(),
                          !1;
                  ...
                  g.el.normalize();
                  var r = !1;
                  0 < C(t).parentsUntil(g.$el, "BLOCKQUOTE").length && (r = !0),
                  C(t).parentsUntil(g.$el, "TD, TH").length && (r = !1),
                  h(t) ? !b(t) || e || r ? y(t, e, r) : g.cursorLists._endEnter(t) : u(t) ? !b(t) || e || r ? function f(e, t, n) {
                      var r, o = g.node.deepestParent(e, [], !n);
                      if (o && "TABLE" === o.tagName)
                          return C(o).find("td, th").first().prepend(e),
                          f(e, t, n);
                      if (o && "BLOCKQUOTE" === o.tagName)
                          if (m(e, o)) {
                              if (!t)
                                  return (r = g.html.defaultTag()) ? C(o).before("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : C(o).before("".concat(V.MARKERS, "<br>")),
                                  C(e).remove(),
                                  !1
                          } else
                              v(e, o) ? y(e, t, !0) : S(e, t, !0);
                      if (null === o)
                          (r = g.html.defaultTag()) && g.node.isElement(e.parentNode) ? C(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : C(e).replaceWith("<br>".concat(V.MARKERS));
                      else {
                          if (r = g.html.defaultTag(),
                          g.node.isBlock(o))
                              if ("PRE" === o.tagName && (t = !0),
                              t)
                                  C(e).remove(),
                                  C(o).prepend("<br>".concat(V.MARKERS));
                                  ...
                                  if (g.node.isEmpty(o, !0))
                                      return y(e, t, n);
                                  if (g.opts.keepFormatOnDelete || "DIV" === o.tagName || "div" === g.html.defaultTag())
                                      if (!g.opts.keepFormatOnDelete && "DIV" === o.tagName || "div" === g.html.defaultTag())
                                          C(o).before("<" + g.html.defaultTag() + "><br></" + g.html.defaultTag() + ">");
                                      else if (g.opts.keepFormatOnDelete && !g.opts.htmlUntouched && "DIV" !== o.tagName && "div" !== g.html.defaultTag() && u(g.selection.get().focusNode))
                                          C(o).before("".concat(g.node.openTagString(C(o).clone().removeAttr("id").get(0)), "<br>").concat(g.node.closeTagString(o)));
                                      else {
                                          for (var i = e, a = V.INVISIBLE_SPACE; i !== o && !g.node.isElement(i); )
                                              i = i.parentNode,
                                              a = g.node.openTagString(i) + a + g.node.closeTagString(i);
                                          C(o).before(a)
                                      }
                                  else
                                      C(o).before("".concat(g.node.openTagString(C(o).clone().removeAttr("id").get(0)), "<br>").concat(g.node.closeTagString(o)))
                  ...
                  function p() {
                      g.$el.find(".fr-to-remove").each(function() {
                          for (var e = g.node.contents(this), t = 0; t < e.length; t++)
                              e[t].nodeType === Node.TEXT_NODE && (e[t].textContent = e[t].textContent.replace(/\u200B/g, ""));
                          C(this).replaceWith(this.innerHTML)
                      })
                  }(),
                  g.html.fillEmptyBlocks(!0),
                  g.opts.htmlUntouched || (g.html.cleanEmptyTags(),
                  g.clean.lists(),
                  g.spaces.normalizeAroundCursor()),
                  g.selection.restore();
                  ...
                  if (g.$oel[0].offsetHeight > o) {
                      ...
                      if (i) {
                          ...
                          g.opts.scrollableContainer && g.opts.enter !== V.ENTER_BR && "BR" === i.tagName && s + 20 === o && (s = a = i.parentNode.offsetTop),
                          i.parentNode && "TD" === i.parentNode.tagName && o < s ? g.o_win.scroll(0, s - 50) : "BR" === i.tagName && s < 0 ? g.o_win.scroll(0, a - 80) : g.opts.scrollableContainer && o < s + 20 ? g.o_win.scroll(0, a - o + 50) : g.opts.scrollableContainer && s + 2 * g.$tb.height() > g.$sc[0].scrollTop + C(g.$sc).height() && g.$sc[0].scroll(0, a - C(g.$sc).height() + 2 * g.$tb.height())
                      }
                      ...
                      if (l) {
                          ...
                          g.opts.enter !== V.ENTER_BR && "BR" === l.tagName && (d = c = l.parentNode.offsetTop),
                          (g.opts.iframe && d + 2 * g.$tb.height() > g.$sc[0].scrollTop + C(g.$sc).height() || d + 2 * g.$tb.height() > C(g.$sc).height()) && g.$sc[0].scroll(0, c - C(g.$sc).height() + 2 * g.$tb.height())
                      }
                  }
              },
              backspace: function s() {
                  ...
                  return h(t) ? b(t) && m(t, C(t).parents("li").first().get(0)) ? g.cursorLists._backspace(t) : e = E(t) : u(t) ? b(t) && m(t, C(t).parents("li").first().get(0)) ? g.cursorLists._backspace(t) : function c(e) {
                      for (var t = 0 < C(e).parentsUntil(g.$el, "BLOCKQUOTE").length, n = g.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" !== n.tagName && n.parentElement !== g.el && !g.node.hasClass(n.parentElement, "fr-inner") && V.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0; )
                          n = n.parentElement;
                      if (n && "BLOCKQUOTE" === n.tagName) {
                      ...
                      if (null !== n) {
                          ...
                          if (g.node.isBlock(n) && g.node.isEditable(n))
                              if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                                  if (g.node.isDeletable(a))
                                      C(a).remove(),
                                      C(e).replaceWith(V.MARKERS);
                                  else if (g.node.isEditable(a))
                                      if (g.node.isBlock(a))
                                          if (g.node.isEmpty(a) && !g.node.isList(a))
                                              C(a).remove(),
                                              C(e).after(g.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "");
                                          else {
                                              if (g.node.isList(a) && (a = C(a).find("li").last().get(0)),
                                              (i = g.node.contents(a)).length && "BR" === i[i.length - 1].tagName && C(i[i.length - 1]).remove(),
                                              "BLOCKQUOTE" === a.tagName && "BLOCKQUOTE" !== n.tagName)
                                                  for (i = g.node.contents(a); i.length && g.node.isBlock(i[i.length - 1]); )
                                                      a = i[i.length - 1],
                                                      i = g.node.contents(a);
                                              else if ("BLOCKQUOTE" !== a.tagName && "BLOCKQUOTE" === r.tagName)
                                                  for (i = g.node.contents(r); i.length && g.node.isBlock(i[0]); )
                                                      r = i[0],
                                                      i = g.node.contents(r);
                                              if (g.node.isEmpty(n))
                                                  C(e).remove(),
                                                  g.selection.setAtEnd(a, !0);
                                              else {
                                                  C(e).replaceWith(V.MARKERS);
                                                  var s = a.childNodes;
                                              ...
                                              C(r).remove(),
                                              g.node.isEmpty(n) && C(n).remove()
                                          }
                                      else
                                          C(e).replaceWith(V.MARKERS),
                                          "BLOCKQUOTE" === n.tagName && a.nodeType === Node.ELEMENT_NODE ? C(a).remove() : (C(a).after(g.node.isEmpty(n) ? "" : C(n).html()),
                                          C(n).remove(),
                                          "BR" === a.tagName && C(a).remove())
                              } else if (a)
                                  8203 === n.textContent.charCodeAt() && n.childNodes[1] && "BR" === n.childNodes[1].tagName && n.tagName.toLowerCase() === g.html.defaultTag() && n.previousSibling && "TABLE" === n.previousSibling.tagName && C(n).remove();
                              else if (n && "BLOCKQUOTE" === n.tagName && 0 === C(n).text().replace(/\u200B/g, "").length)
                                  C(n).remove();
                              else {
                                  var l = n.nextSibling;
              ...
              del: function r() {
                  ...
                  h(e))
                      if (b(e))
                          if (0 === C(e).parents("li").first().find("ul, ol").length)
                              g.cursorLists._del(e);
                          else {
                              var t = C(e).parents("li").first().find("ul, ol").first().find("li").first();
                              (t = t.find(g.html.blockTagsQuery()).get(-1) || t).prepend(e),
                              g.cursorLists._backspace(e)
                          }
                      else
                          i(e);
                  else
      ...
      V.MODULES.data = function(f) {
          ...
          function g() {
              return; // ! hack // otherwise froala destroys after 10 modifications
              ...
              b = v.find("> a"),
              "rtl" === f.opts.direction && v.css("left", "auto").css("right", 0).attr("direction", "rtl"),
              e++
          }
          function C(e) {
              ...
              _init: function x() {
                  ...
                  for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                      ...
                      if (c === M(p(M("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(T, c.length - T.length) || C(T) || m()) {
                          ...
                          new Date(n) < new Date && (E = y,
                          1)) : new Date(n) < new Date(M(S))) || !(0 < (T || "").length) || C(T) || m()) {
                              f.ul = !1;
                              break
                          }
                          i = !0,
                  ...
                  var d = new Image;
                  !0 === f.ul && (g(),
                  d.src = i ? "".concat(p(M(t)), "e=").concat(a) : "".concat(p(M(t)), "u")),
                  !0 === f.ul && (f.events.on("contentChanged", function() {
                      (function e() {
      ...
      V.MODULES.format = function(x) {
          ...
          function v(e, t, n) {
              ...
              if (e) {
                  var s = "LI" === e.tagName ? e : O(e).parentsUntil(x.$el, "li").get(0)
                    , l = O(s).find(".fr-marker[data-type=false]").get(0);
                  if ("LI" !== e.parentNode.parentNode.tagName || !l || null != l.previousSibling) {
                      if (x.node.isBlock(e) && e.hasAttribute("contenteditable") && "false" === e.getAttribute("contenteditable") || e.parentNode && e.parentNode.hasAttribute("contenteditable") && "false" === e.parentNode.getAttribute("contenteditable")) {
                          if (e.nextSibling && O(e.nextSibling).hasClass("fr-marker"))
                              return;
                          if (e.nextSibling)
                              return void v(e.nextSibling, t, n);
                          if (e.parentNode)
                              return void v(e.parentNode, t, n)
                      }
                      for (; e && e.nodeType === Node.COMMENT_NODE; )
                          e = e.nextSibling;
                      if (e) {
                          if (x.node.isBlock(e) && "HR" !== e.tagName && "LI" !== e.tagName)
                              return x.node.hasClass(e.firstChild, "fr-marker") ? v(e.firstChild.nextSibling, t, n) : v(e.firstChild, t, n),
                              !1;
                          var c = O(x.doc.createElement(t));
                          c.attr(n),
                          c.insertBefore(e),
                          (r = b(e)) && (0 <= ["strong", "em"].indexOf(t) || "span" === t && n.hasOwnProperty("style")) && (i = "span" === t ? (o = (a = n.style.replace(/;$/, "").split(":"))[0].trim(),
                          a[1].trim()) : (o = a[t].prop,
                          a[t].val),
                          "background-color" !== o && (O(r).css(o, i),
                          function C(e, t) {
                              var n, r = e.childNodes;
                              for (n = 0; n < r.length; n++)
                                  0 <= ["UL", "OL", "LI"].indexOf(r[n].tagName) && "" === r[n].style[t] && O(r[n]).css(t, "initial")
                          }(r, o)));
                          for (var d = e; d && !O(d).hasClass("fr-marker") && 0 === O(d).find(".fr-marker").length && "UL" !== d.tagName && "OL" !== d.tagName; ) {
                              var f = d;
                              if ("SPAN" === d.tagName && O(d).hasClass("fr-tracking-deleted"))
                                  d = d.nextSibling;
                              else {
                                  if (x.node.isBlock(d) && "HR" !== e.tagName)
                                      return v(d.firstChild, t, n),
                                      !1;
                                  if ("SPAN" === d.tagName && x.node.isEditable(d))
                                      return c.is(":empty") && c.remove(),
                                      v(d.firstChild, t, n),
                                      !1;
                                  if (d.tagName && d.hasAttribute("contenteditable") && "false" === d.getAttribute("contenteditable")) {
                                      var p = c.get(0).parentNode
                                        , h = d.nextSibling;
                                      return "P" === d.parentNode.tagName && null == d.nextSibling ? h = d.parentNode.nextSibling : !h && p && p.nextSibling && "DIV" === p.nextSibling.tagName && (h = p.nextSibling),
                                      void v(h, t, n)
                                  }
                                  if (!x.node.isEditable(d.parentNode))
                                      return x.selection.restore(),
                                      void x.toolbar.disable();
                                  d = d.nextSibling,
                                  c.append(f),
                                  x.browser.mozilla && 0 < c.length && m(c[0])
                              }
                          }
                          if (d)
                              (O(d).find(".fr-marker").length || "UL" === d.tagName || "OL" === d.tagName) && v(d.firstChild, t, n);
                          else {
                              for (var u = c.get(0).parentNode; u && !u.nextSibling && !x.node.isElement(u); )
                                  u = u.parentNode;
                              if (u) {
                                  var g = u.nextSibling;
                                  g && (x.node.isBlock(g) ? "HR" === g.tagName ? v(g.nextSibling, t, n) : v(g.firstChild, t, n) : v(g, t, n))
                              }
                          }
                          c.is(":empty") && c.remove()
                      }
          ...
          function m(e) {
              if (O(e).parentsUntil(x.$el, "TABLE").length) {
                  for (var t = null, n = e.nextSibling; n; )
                      "BR" === n.nodeName && (t = n),
                      n = n.nextSibling;
                  t && !t.nextSibling && "TD" != t.parentNode.nodeName && t.parentNode.textContent && t.remove()
              }
          }
          function l(e, t) {
              var n;
              ...
              x.selection.isCollapsed()) {
                  x.markers.insert();
                  var r = x.$el.find(".fr-marker");
                  r.get(0).nextSibling && x.node.isBlock(r.get(0).nextSibling) && !r.get(0).previousSibling && "LI" === r.get(0).parentNode.tagName && r.get(0).nextSibling.prepend(r.get(0)),
                  r.replaceWith(function l(e, t) {
                      var n = "<".concat(e);
                      for (var r in t)
                  ...
                  x.selection.save();
                  var o, i = x.$el.find('.fr-marker[data-type="true"]').length && x.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling;
                  v(i, e, t),
                  O(i).parent().find("a:empty").remove();
                  do {
                      for (o = x.$el.find("".concat(w(e, t), " > ").concat(w(e, t))),
                      n = 0; n < o.length; n++)
                          o[n].outerHTML = o[n].innerHTML
                  } while (o.length);
                  x.el.normalize();
                  var a = x.el.querySelectorAll(".fr-marker");
                  for (n = 0; n < a.length; n++) {
                      var s = O(a[n]);
                      !0 === s.data("type") ? k(s.get(0).nextSibling, w(e, t)) && s.next().prepend(s) : k(s.get(0).previousSibling, w(e, t)) && s.prev().append(s)
                  }
                  x.selection.restore()
              }
          }
          function $(e, t, n, r) {
              ...
              if (e.parents(t).length || void 0 === t) {
                  ...
                  if ("A" === l[0].tagName && (l = l.parent()),
                  l.is(x.$el) || x.node.isBlock(l.get(0)))
                      return !1;
                  for (; !(x.node.isBlock(l.parent().get(0)) || void 0 !== t && k(l.get(0), w(t, n))); )
                      a += x.node.closeTagString(l.get(0)),
                      s = x.node.openTagString(l.get(0)) + s,
                      l = l.parent();
                  var c = e.get(0).outerHTML;
                  return e.replaceWith('<span id="mark"></span>'),
                  i = l.html().replace(/<span id="mark"><\/span>/, a + x.node.closeTagString(l.get(0)) + s + c + a + x.node.openTagString(l.get(0)) + s),
                  l.replaceWith(x.node.openTagString(l.get(0)) + i + x.node.closeTagString(l.get(0))),
                  !0
              }
              return !1
          }
          function c(e, t) {
              ...
              x.selection.save();
              var r = x.$el.find(".fr-marker");
              if (e && r.length && (r[0].parentNode && r[0].parentNode.tagName === e.toUpperCase() || r[1].parentNode.tagName === e.toUpperCase())) {
                  var o = r[0];
                  r[0].parentNode.tagName !== e.toUpperCase() && (o = r[1]);
                  for (var i = o.parentNode.previousSibling; null != i; )
                      i.nodeType === Node.TEXT_NODE && (i.textContent = i.textContent.replace(/\u200B/g, "")),
                      i = i.previousSibling;
                  for (var a = o.parentNode.nextSibling; null != a; )
                      a.nodeType === Node.TEXT_NODE && (a.textContent = a.textContent.replace(/\u200B/g, "")),
                      a = a.nextSibling
              }
              for (var s = !0; s; ) {
                  s = !1;
                  for (var l = x.$el.find(".fr-marker"), c = 0; c < l.length; c++) {
                      var d = O(l[c])
                        , f = null;
                      if (d.attr("data-cloned") || n || (f = d.clone().removeClass("fr-marker").addClass("fr-clone"),
                      d.data("type") && "true" === d.data("type").toString() ? d.attr("data-cloned", !0).after(f) : d.attr("data-cloned", !0).before(f)),
                      $(d, e, t, n)) {
                          s = !0;
                          break
                      }
              ...
              !function M(e, t, n, r) {
                  ...
                  }, a = x.node.contents(e.get(0)), s = 0; s < a.length; s++) {
                      var l = a[s];
                      if (l.innerHTML && 8203 == l.innerHTML.charCodeAt() && l.tagName.toLocaleLowerCase() == n && l.childNodes.length < 2 && !x.helpers.isMobile() && (l.outerHTML = l.innerHTML),
                      x.node.hasClass(l, "fr-marker"))
                          t = (t + 1) % 2;
                      else if (t)
                          if (0 < O(l).find(".fr-marker").length)
                              t = M(O(l), t, n, r);
                          else {
                              (o = "LI" === l.tagName ? l : O(l).parentsUntil(x.$el, "li").get(0)) && (void 0 === n || 0 <= ["strong", "em"].indexOf(n)) && (n ? O(o).css(i[n].prop, "") : o.style = ""),
                              (o = l.parentNode !== x.el ? l.parentNode : null) && 1 === o.nodeType && ["p", "strong", "u", "em", "s", "sub", "sup", "a"].indexOf(n) < 0 && o.hasAttribute("style") && "SPAN" !== o.tagName && "LI" !== o.tagName ? o.style = "" : l && 1 === l.nodeType && l.hasAttribute("style") && ["p", "strong", "u", "em", "s", "sub", "sup", "a"].indexOf(n) < 0 && (x.browser.msie ? O(l).attr("style", "") : l.style = "");
                              for (var c = O(l).find(n || "*:not(br)"), d = c.length - 1; 0 <= d; d--) {
                                  var f = c[d];
                                  (o = "LI" === f.tagName ? f : O(f).parentsUntil(x.$el, "li").get(0)) && (!n || 0 <= ["strong", "em"].indexOf(n)) && (n ? O(o).css(i[n].prop, "") : o.style = ""),
                                  "A" === f.tagName || x.node.isBlock(f) || x.node.isVoid(f) || void 0 !== n && !k(f, w(n, r)) ? x.node.isBlock(f) && void 0 === n && "TABLE" !== l.tagName && x.node.clearAttributes(f) : x.node.hasClass(f, "fr-clone") || x.node.hasClass(f, "fr-tracking-deleted") || O(f).data("tracking") || (f.outerHTML = f.innerHTML)
                              }
                              "A" !== l.tagName && void 0 === n && l.nodeType === Node.ELEMENT_NODE && !x.node.isVoid(l) || k(l, w(n, r)) ? x.node.isBlock(l) || (x.node.hasClass(l, "fr-clone") || x.opts.trackChangesEnabled ? !x.node.hasClass(l, "fr-clone") && x.opts.trackChangesEnabled && l.parentNode && (l.outerHTML = l.innerHTML) : l.outerHTML = l.innerHTML) : void 0 === n && l.nodeType === Node.ELEMENT_NODE && x.node.isBlock(l) && "TABLE" !== l.tagName && x.node.clearAttributes(l)
                          }
                      else
                          0 < O(l).find(".fr-marker").length && (t = M(O(l), t, n, r))
                  }
                  return t
              }(x.$el, 0, e, t),
              n || (x.$el.find(".fr-marker").remove(),
              x.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")),
              n && x.$el.find(".fr-marker").before(V.INVISIBLE_SPACE).after(V.INVISIBLE_SPACE),
              x.html.cleanEmptyTags(),
              x.el.normalize(),
              x.selection.restore();
              var p = x.win.getSelection() && x.win.getSelection().anchorNode;
              if (p) {
                  var h = x.node.blockParent(p)
                    , u = !!p.textContent.replace(/\u200B/g, "").length
                    , g = x.win.getSelection().getRangeAt(0)
                    , C = g.startOffset
                    , m = g.endOffset;
                  x.selection.text().replace(/\u200B/g, "").length || function A(e, t) {
                      if (e && t) {
                  ...
                  var v = x.win.getSelection().getRangeAt(0);
                  if (p.nodeType === Node.TEXT_NODE) {
                      if (!u || !x.selection.text().length && C === m) {
                          var b = p.textContent.search(/\u200B/g) + 1;
                          if (x.browser.msie) {
                              var L = x.doc.createRange();
                              x.selection.get().removeAllRanges(),
                              L.setStart(p, b),
                              L.setEnd(p, b),
                              x.selection.get().addRange(L)
                          } else
                              "a" !== e && (v.setStart(p, b),
                              v.setEnd(p, b))
                      }
                  } else {
                      var E, y, S = 0, N = O(p).contents();
                      if (x.browser.msie) {
                          for (; y = N[S]; )
                              y.nodeType === Node.TEXT_NODE && 0 <= y.textContent.search(/\u200B/g) && (E = y),
                              S++;
                          E = O(E)
                      } else
          ...
          function t(e, t) {
              ...
              if (x.selection.isCollapsed()) {
                  x.markers.insert();
                  var d = (r = x.$el.find(".fr-marker")).parent();
                  if (x.node.openTagString(d.get(0)) === '<span style="'.concat(e, ": ").concat(d.css(e), ';">')) {
                      if (x.node.isEmpty(d.get(0)))
                          c = O(x.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)),
                          d.replaceWith(c);
                      else {
                          var f = {};
                          f["style*"] = "".concat(e, ":"),
                          $(r, "span", f, !0),
                          r = x.$el.find(".fr-marker"),
                          t ? (c = O(x.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)),
                          r.replaceWith(c)) : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS)
                      }
                      x.html.cleanEmptyTags()
                  } else
                      x.node.isEmpty(d.get(0)) && d.is("span") ? (r.replaceWith(V.MARKERS),
                      d.css(e, t)) : (r.get(0).nextSibling && x.node.isBlock(r.get(0).nextSibling) && !r.get(0).previousSibling && "LI" === r.get(0).parentNode.tagName && r.get(0).nextSibling.prepend(r.get(0)),
                      c = O(t ? '<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>") : "<span>".concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>")),
                      r.replaceWith(c));
                  c && L(c, e, t)
              } else {
                  if (x.selection.save(),
                  null === t || "color" === e && 0 < x.$el.find(".fr-marker").parents("u, a").length) {
                      var p = x.$el.find(".fr-marker");
                      for (n = 0; n < p.length; n++)
                          if (!0 === (r = O(p[n])).data("type") || "true" === r.data("type"))
                              for (; x.node.isFirstSibling(r.get(0)) && !r.parent().is(x.$el) && !x.node.isElement(r.parent().get(0)) && !x.node.isBlock(r.parent().get(0)); )
                                  r.parent().before(r);
                          else
                              for (; x.node.isLastSibling(r.get(0)) && !r.parent().is(x.$el) && !x.node.isElement(r.parent().get(0)) && !x.node.isBlock(r.parent().get(0)); )
                                  r.parent().after(r)
                  }
                  for (var h = x.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; h.firstChild; )
                      h = h.firstChild;
                  var u = {
                      "class": "fr-unprocessed"
                  };
                  for (t && (u.style = "".concat(e, ": ").concat(t, ";")),
                  v(h, "span", u),
                  x.$el.find(".fr-marker + .fr-unprocessed").each(function() {
                      O(this).prepend(O(this).prev())
                  }),
                  x.$el.find(".fr-unprocessed + .fr-marker").each(function() {
                      O(this).prev().append(O(this))
                  }),
                  (t || "").match(/\dem$/) && x.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed"); 0 < x.$el.find("span.fr-unprocessed").length; ) {
                      if (o = b(c = x.$el.find("span.fr-unprocessed").first().removeClass("fr-unprocessed")),
                      c.parent().get(0).normalize(),
                      c.parent().is("span") && 1 === c.parent().get(0).childNodes.length) {
                          var g = t;
                          x.browser.msie && !t && (g = ""),
                          c.parent().css(e, g);
                          var C = c;
                      ...
                      for (i = c.find("span"),
                      o && "background-color" !== e && (o.normalize(),
                      i = O(o).find("span:not(.fr-unprocessed)")),
                      n = i.length - 1; 0 <= n; n--)
                          a = i[n],
                          s = e,
                          l = void 0,
                          (l = O(a)).css(s, ""),
                          "" === l.attr("style") && l.replaceWith(l.html());
                      L(c, e, t)
                  }
              }
              !function m() {
                  ...
                  x.$el.find(".fr-split").removeClass("fr-split"),
                  x.$el.find('[style=""]').removeAttr("style"),
                  x.$el.find('[class=""]').removeAttr("class"),
                  x.html.cleanEmptyTags();
                  for (var t = x.$el.find("span"), n = t.length - 1; 0 <= n; n--) {
                      var r = t[n];
                      r.attributes && 0 !== r.attributes.length || O(r).replaceWith(r.innerHTML)
                  }
                  x.el.normalize();
                  var o = x.$el.find("span[style] + span[style]");
                  for (e = 0; e < o.length; e++) {
                      var i = O(o[e])
                        , a = O(o[e]).prev();
                      i.get(0).previousSibling === a.get(0) && x.node.openTagString(i.get(0)) === x.node.openTagString(a.get(0)) && (i.prepend(a.html()),
                      a.remove())
                  }
                  x.$el.find("span[style] span[style]").each(function() {
                      if (0 <= O(this).attr("style").indexOf("font-size")) {
                          var e = O(this).parents("span[style]");
                          e.attr("style") && 0 <= e.attr("style").indexOf("background-color") && (O(this).attr("style", "".concat(O(this).attr("style"), ";").concat(e.attr("style"))),
                          $(O(this), "span[style]", {}, !1))
                      }
                  }),
                  x.el.normalize(),
          ...
          function b(e) {
              var t, n, r, o, i, a;
              if (t = "LI" === e.tagName ? e : O(e).parentsUntil(x.$el, "li").get(0)) {
                  if ((a = x.selection.info(t)).atStart && a.atEnd)
                      return t;
                  if (a.atStart && !a.atEnd && (n = O(t).find(".fr-marker[data-type=false]").get(0),
                  r = O(n).parentsUntil(x.$el, "li").get(0),
                  o = O(n).parent().get(0),
                  (i = n.nextSibling) && 0 <= ["UL", "OL"].indexOf(i.tagName) || !r.isSameNode(t) || !i && ("LI" === o.tagName || !o.nextSibling || 0 <= ["UL", "OL"].indexOf(o.nextSibling.tagName) || x.node.isVoid(o.nextSibling))))
                      return t
              }
          }
          function L(e, t, n) {
              var r, o, i, a = e.parentsUntil(x.$el, "span[style]"), s = [];
              for (r = a.length - 1; 0 <= r; r--)
                  o = a[r],
                  i = t,
                  0 === O(o).attr("style").indexOf("".concat(i, ":")) || 0 <= O(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= O(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
              if ((a = a.not(s)).length) {
                  for (var l = "", c = "", d = "", f = "", p = e.get(0); p = p.parentNode,
                  O(p).addClass("fr-split"),
                  l += x.node.closeTagString(p),
                  c = x.node.openTagString(O(p).clone().addClass("fr-split").get(0)) + c,
                  a.get(0) !== p && (d += x.node.closeTagString(p),
                  f = x.node.openTagString(O(p).clone().addClass("fr-split").get(0)) + f),
                  a.get(0) !== p; )
                      ;
                  var h = "".concat(l + x.node.openTagString(O(a.get(0)).clone().css(t, n || "").get(0)) + f + e.css(t, "").get(0).outerHTML + d, "</span>").concat(c);
                  e.replaceWith('<span id="fr-break"></span>');
                  var u = a.get(0).outerHTML;
                  O(a.get(0)).replaceWith(u.replace(/<span id="fr-break"><\/span>/g, function() {
                      return h
                  }))
              }
          }
          function d(e, t) {
              ...
              !n.collapsed && r.nodeType === Node.TEXT_NODE && n.startOffset === (r.textContent || "").length) {
                  for (; !x.node.isBlock(r.parentNode) && !r.nextSibling; )
                      r = r.parentNode;
                  r.nextSibling && (r = r.nextSibling)
              }
              for (var o = r; o && o.nodeType === Node.ELEMENT_NODE && !k(o, w(e, t)); )
                  o = o.firstChild;
              if (o && o.nodeType === Node.ELEMENT_NODE && k(o, w(e, t)))
                  return !0;
              var i = r;
              for (i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType === Node.ELEMENT_NODE && i !== x.el && !k(i, w(e, t)); )
                  i = i.parentNode;
              return !(!i || i.nodeType !== Node.ELEMENT_NODE || i === x.el || !k(i, w(e, t)))
          }
          return {
              is: d,
              toggle: function f(e, t) {
                  if (x.browser.safari && x.shared.safariSelection) {
                      ...
                      s.setEnd(o, a),
                      x.selection.get().removeAllRanges(),
                      x.selection.get().addRange(s),
                      x.shared.safariSelection = null
                  }
                  d(e, t) ? c(e, t) : l(e, t)
              },
              apply: l,
      ...
      V.MODULES.spaces = function(c) {
          function r(e, t) {
              ...
              if (!c.html.isPreformatted(i)) {
                  ...
                  (c.node.isBlock(r) || c.node.isBlock(n)) && (!n || n && "A" !== n.tagName) && (o = o.replace(/^[\f\n\r\t\v ]{1,}/g, "")),
                  ...
                  for (var s = "", l = 0; l < o.length; l++)
                      32 != o.charCodeAt(l) || 0 !== l && 32 != s.charCodeAt(l - 1) || !((c.opts.enter === V.ENTER_BR || c.opts.enter === V.ENTER_DIV) && (n && "BR" === n.tagName || r && "BR" === r.tagName) || n && r && n.tagName === r.tagName || !(n && r && c.node.isVoid(n) || n && r && c.node.isVoid(r)) || n && r && 0 <= ["STRONG", "U", "EM"].indexOf(n.tagName) && "BR" === r.tagName) ? s += o[l] : s += V.UNICODE_NBSP;
                  c.browser.chrome && 1 < s.length && 32 === s.charCodeAt(s.length - 1) && (r && r.nextSibling && r.nextSibling.nextSibling && "BR" === r.nextSibling.nextSibling.tagName || r && "BR" === r.tagName) && (s = s.substring(0, s.length - 1) + V.UNICODE_NBSP),
                  ...
                  try {
                      ...
                      if (!0 === t && !e.collapsed) {
                          for (; !d.node.isElement(r.parentNode) && !i; )
                              -1 < /\bfa\b/g.test(r.parentNode.className) && "I" === r.parentNode.tagName ? f(r.parentNode).before(r) : f(r.parentNode).after(r),
                              i = r.nextSibling;
      ...
      V.MODULES.selection = function(E) {
          ...
          function s() {
              var e = "";
              return E.win.getSelection ? e = E.win.getSelection() : E.doc.getSelection ? e = E.doc.getSelection() : E.doc.selection && (e = E.doc.selection.createRange().text),
              e.toString()
          }
          function L() {
                  ...
                  if (0 < a.length) {
                      ...
                      try {
                          ...
                          if (o.nextSibling === a || a.nextSibling === o) {
                              for (var p = o.nextSibling === a ? o : a, h = p === o ? a : o, u = p.previousSibling; u && u.nodeType === Node.TEXT_NODE && 0 === u.length; )
                                  u = (d = u).previousSibling,
                                  y(d).remove();
                              if (u && u.nodeType === Node.TEXT_NODE)
                                  for (; u && u.previousSibling && u.previousSibling.nodeType === Node.TEXT_NODE; )
                                      u.previousSibling.textContent += u.textContent,
                                      u = u.previousSibling,
                                      y(u.nextSibling).remove();
                              for (var g = h.nextSibling; g && g.nodeType === Node.TEXT_NODE && 0 === g.length; )
                                  g = (d = g).nextSibling,
                                  y(d).remove();
                              ...
                              if (u && (E.node.isVoid(u) || E.node.isBlock(u)) && (u = null),
                              g && (E.node.isVoid(g) || E.node.isBlock(g)) && (g = null),
                              u && g && u.nodeType === Node.TEXT_NODE && g.nodeType === Node.TEXT_NODE) {
                                  y(o).remove(),
                                  y(a).remove();
                                  var C = u.textContent.length;
                                  u.textContent += g.textContent,
                                  y(g).remove(),
                                  E.spaces.normalize(u),
                                  i.setStart(u, C),
                                  i.setEnd(u, C),
                                  l = !0
                              } else
                                  !u && g && g.nodeType === Node.TEXT_NODE ? (y(o).remove(),
                                  y(a).remove(),
                                  ...
                                  i.setStart(g, 0),
                                  i.setEnd(g, 0),
                                  l = !0) : !g && u && u.nodeType === Node.TEXT_NODE && (y(o).remove(),
                                  y(a).remove(),
                                  E.opts.htmlUntouched || E.spaces.normalize(u),
                                  s = y(E.doc.createTextNode("\u200b")).get(0),
                                  y(u).after(s),
                                  i.setStart(u, u.textContent.length),
                                  i.setEnd(u, u.textContent.length),
                                  l = !0)
                          }
                          if (!l) {
                              var m = void 0
                                , v = void 0;
                              v = (E.browser.chrome || E.browser.edge) && o.nextSibling === a ? (m = M(a, i, !0) || i.setStartAfter(a),
                              M(o, i, !1) || i.setEndBefore(o)) : (o.previousSibling === a && (a = (o = a).nextSibling),
                              a.nextSibling && "BR" === a.nextSibling.tagName || !a.nextSibling && E.node.isBlock(o.previousSibling) || o.previousSibling && "BR" === o.previousSibling.tagName || (o.style.display = "inline",
                              a.style.display = "inline",
                              s = y(E.doc.createTextNode("\u200b")).get(0)),
                              m = M(o, i, !0) || y(o).before(s) && i.setStartBefore(o),
          ...
          function M(e, t, n) {
              ...
              n ? (E.opts.htmlUntouched || E.spaces.normalize(o),
              function() {
                  t.setStart(o, r)
              }
              ) : (E.opts.htmlUntouched || E.spaces.normalize(o),
              ...
              )) : !(!i || o || i.nodeType !== Node.TEXT_NODE) && (n ? (E.opts.htmlUntouched || E.spaces.normalize(i),
              function() {
                  t.setStart(i, 0)
              }
              ) : (E.opts.htmlUntouched || E.spaces.normalize(i),
          ...
          function o(e) {
              ...
              if (E.win.getSelection) {
                  ...
                  E.doc.selection && "Control" !== E.doc.selection.type && ((n = (t = E.doc.selection.createRange()).duplicate()).moveToElementText(e),
          ...
          function h() {
              try {
                  if (!E.$wp)
                      return !1;
                  for (var e = f(0).commonAncestorContainer; e && !E.node.isElement(e); )
                      e = e.parentNode;
          ...
          function i(e, t) {
              ...
              r.innerHTML = V.MARKERS; e.parentNode && E.opts.htmlAllowedEmptyTags && 0 <= E.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase()); )
                  e = e.parentNode;
              e.appendChild(r);
          ...
          return {
              ...
              remove: function w() {
                              ...
                              if (d) {
                                  if (l && (!c || c !== d)) {
                                      var f = E.node.blockParent(l)
                                        ...
                                        , h = !1
                                        , u = !1;
                                      if (f && 0 <= ["UL", "OL"].indexOf(f.tagName) && (h = !(f = null)),
                                      p && 0 <= ["UL", "OL"].indexOf(p.tagName) && (u = !(p = null)),
                                      y(l).after(d),
                                      f !== p)
                                          if (null !== f || h)
                                              if (null !== p || u || 0 !== y(f).parentsUntil(E.$el, "table").length)
                                                  f && p && 0 === y(f).parentsUntil(E.$el, "table").length && 0 === y(p).parentsUntil(E.$el, "table").length && !y(f).contains(p) && !y(p).contains(f) && (y(f).append(y(p).html()),
                                                  y(p).remove());
                                              else {
                                              ...
                                              C ? (y(C).after(y(p).html()),
                                              y(p).remove()) : 0 === y(p).parentsUntil(E.$el, "table").length && (y(l).next().after(y(p).html()),
                                              y(p).remove())
                                          }
                                  }
                              } else
                  ...
                  E.opts.htmlUntouched || (E.clean.lists(),
                  E.$el.find("li:empty").append("<br>"),
                  E.spaces.normalize());
                  var m = E.$el.find(".fr-marker").last().get(0)
                    , v = E.$el.find(".fr-marker").first().get(0);
                  void 0 !== m && void 0 !== v && !m.nextSibling && v.previousSibling && "BR" === v.previousSibling.tagName && E.node.isElement(m.parentNode) && E.node.isElement(v.parentNode) && E.$el.append("<br>"),
                  T()
              },
              blocks: function u(e) {
                  var t, n, r = [], o = L();
                  if (h() && o.rangeCount) {
                      ...
                      for (t = 0; t < i.length; t++) {
                          ...
                          (E.node.isBlock(s) || E.node.hasClass(s, "fr-inner")) && r.indexOf(s) < 0 && r.push(s);
                          for (var c = [], d = s; d !== l && d !== E.el; )
                              c.indexOf(d) < 0 && d.children && d.children.length ? (c.push(d),
                              d = d.children[0]) : d.nextSibling ? d = d.nextSibling : d.parentNode && (d = d.parentNode,
                              c.push(d)),
                              E.node.isBlock(d) && c.indexOf(d) < 0 && r.indexOf(d) < 0 && (d !== l || 0 < a.endOffset) && r.push(d);
                          E.node.isBlock(l) && r.indexOf(l) < 0 && 0 < a.endOffset && r.push(l),
                          (n = E.node.blockParent(l)) && r.indexOf(n) < 0 && r.push(n)
                      }
                  }
                  for (t = r.length - 1; 0 < t; t--)
                      if (y(r[t - 1]).contains(r[t])) {
                          if (e && y(r[t]).find("ul, ol").length)
                              continue;
                          r.splice(t - 1, 1)
              ...
              setBefore: function g(e, t) {
                  ...
                  for (var n = e.previousSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length; )
                      n = n.previousSibling;
                  return n ? (E.node.isBlock(n) ? i(n) : "BR" === n.tagName ? y(n).before(V.MARKERS) : y(n).after(V.MARKERS),
                  !0) : !!t && (E.node.isBlock(e) ? r(e) : y(e).before(V.MARKERS),
                  !0)
              },
              setAfter: function C(e, t) {
                  ...
                  for (var n = e.nextSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length; )
                      n = n.nextSibling;
                  return n ? (E.node.isBlock(n) ? r(n) : y(n).before(V.MARKERS),
                  !0) : !!t && (E.node.isBlock(e) ? i(e) : y(e).after(V.MARKERS),
                  !0)
              },
              rangeElement: p
          }
      ...
      V.MODULES.html = function(w) {
          ...
          function e(e) {
              ...
              r = u.merge(r, w.opts.htmlAllowedEmptyTags),
              r = void 0 === e ? u.merge(r, V.BLOCK_TAGS) : u.merge(r, V.NO_DELETE_TAGS),
              ...
              n) {
                  for (var r = w.doc.createDocumentFragment(), o = null, i = !1, a = e.firstChild, s = !1; a; ) {
                      ...
                      if (a.nodeType === Node.ELEMENT_NODE && (w.node.isBlock(a) || 0 <= w.opts.htmlDoNotWrapTags.indexOf(a.tagName.toLowerCase()) && !w.node.hasClass(a, "fr-marker")))
                          ...
                          a && a.parentNode && ["TD", "TH"].indexOf(a.parentNode.tagName) < 0 && r.appendChild(o)) : !1 === i && (o.appendChild(w.doc.createElement("br")),
                          t && (o.setAttribute("class", "fr-temp-div"),
                          o.setAttribute("data-empty", !0))),
                          o = null;
                      else {
                          ...
                          if (a.nodeType !== Node.TEXT_NODE || 0 < c.replace(/\n/g, "").replace(/(^ *)|( *$)/g, "").length || c.replace(/(^ *)|( *$)/g, "").length && c.indexOf("\n") < 0) {
                              ...
                              i = !1),
                              o.appendChild(a.cloneNode(!0)),
                              i || w.node.hasClass(a, "fr-marker") || a.nodeType === Node.TEXT_NODE && 0 === c.replace(/ /g, "").length || (i = !0)
                          } else
                              s = !0
                      }
                      a = l
          ...
          function o() {
              w.node.isEmpty(w.el) && (null !== d() ? w.el.querySelector(p()) || w.el.querySelector("".concat(w.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || (w.core.hasFocus() ? (w.$el.html("<".concat(d(), ">").concat(V.MARKERS, "<br/></").concat(d(), ">")),
          ...
          function h(e) {
              ...
              do {
                  ...
                  for (var i = 0; i < n.length; i++) {
                      ...
                      if (t !== a) {
                          var s = a.textContent;
                          0 === a.children.length && 1 === s.length && 8203 === s.charCodeAt(0) && ["TD", "STRONG", "SPAN", "EM", "U", "S", "SUB", "SUP"].indexOf(a.tagName) < 0 && (u(a).remove(),
                          r = !0)
                      }
                  }
              } while (r)
          ...
          return {
              ...
              fillEmptyBlocks: function y(e) {
                  ...
                  for (var n = 0; n < t.length; n++) {
                      var r = t[n];
                      "false" === r.getAttribute("contenteditable") || r.querySelector("".concat(w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || w.node.isVoid(r) || "TABLE" === r.tagName || "TBODY" === r.tagName || "TR" === r.tagName || "UL" === r.tagName || "OL" === r.tagName || r.querySelector("br") || r.appendChild(w.doc.createElement("br"))
                  }
              ...
              get: function B(e, t) {
                          ...
                          if (c)
                              for (var f = 0, p = c.length; f < p; f++)
                                  if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                                      var h = c[f].selectorText.replace(/body \s tbody \.fr-view /g, "").replace(/::/g, ":")
                                        , u = void 0;
                                      try {
                                          u = w.el.querySelectorAll(h)
                                      } catch (O) {
                                          u = []
                                      }
                                      for (o = 0; o < u.length; o++) {
                                          !u[o].getAttribute("fr-original-style") && u[o].getAttribute("style") ? (u[o].setAttribute("fr-original-style", u[o].getAttribute("style")),
                                          i.push(u[o])) : u[o].getAttribute("fr-original-style") || (u[o].setAttribute("fr-original-style", ""),
                                          i.push(u[o])),
                                          a[u[o]] || (a[u[o]] = {});
                                          for (var g = 1e3 * d + $(c[f].selectorText), C = c[f].style.cssText.split(";"), m = 0; m < C.length; m++) {
                                              var v = C[m].trim().split(":")[0];
                                              if (v && !v.match(l) && ((!a[u[o]][v] || a[u[o]][v] && "" == u[o].getAttribute("fr-original-style")) && (a[u[o]][v] = 0) <= (u[o].getAttribute("fr-original-style") || "").indexOf("".concat(v, ":")) && (a[u[o]][v] = 1e4),
                                              g >= a[u[o]][v] && (a[u[o]][v] = g,
                                              C[m].trim().length))) {
                                                  var b = C[m].trim().split(":");
                                                  b.splice(0, 1);
                                                  var L = b.join(":").trim();
                                                  -1 < L.indexOf("!important") && (g += 1),
                                                  s.push([u[o], v.trim(), L, g])
                                              }
                                          }
                                      }
                                  }
                  ...
                  w.opts.fullPage) {
                      ...
                      w.opts.iframe && w.$html && 0 < w.$html.find(".fr-element").length && (n = w.$html.find(".fr-element").html()),
                      w.opts.heightMin = T,
                      w.opts.height = M,
                      w.opts.heightMax = A,
                      w.size.refresh(),
              ...
              getSelected: function T() {
                  function e(e, t) {
                      for (; t && (t.nodeType === Node.TEXT_NODE || !w.node.isBlock(t)) && !w.node.isElement(t) && !w.node.hasClass(t, "fr-inner") && (w.opts.enter !== V.ENTER_BR || t !== w.$el[0]); )
                          t && t.nodeType !== Node.TEXT_NODE && u(e).wrapContent(t),
                          t = t.parentNode;
                      t && e.innerHTML === t.innerHTML ? e.innerHTML = t.outerHTML : t && "DIV" !== t.tagName && t.innerText && -1 != t.innerText.indexOf(e.innerHTML) && t !== w.$el.get(0) && (e.innerHTML = w.node.openTagString(t) + e.innerHTML + w.node.closeTagString(t))
                  }
                  var t, n, r = "";
                  if ("undefined" != typeof w.win.getSelection) {
                      ...
                      for (var o = w.selection.ranges(), i = 0; i < o.length; i++) {
                          ...
                          e(a, (n = t = void 0,
                          n = null,
                          w.win.getSelection ? (t = w.win.getSelection()) && t.rangeCount && ((n = t.getRangeAt(0).commonAncestorContainer).nodeType === Node.ELEMENT_NODE || w.opts.enter === V.ENTER_BR && n.parentNode === w.$el[0] || (n = n.parentNode)) : (t = w.doc.selection) && "Control" !== t.type && (n = t.createRange().parentElement()),
                          null !== n && (0 <= u(n).parents().toArray().indexOf(w.el) || n === w.el) ? n : null)),
                          0 < u(a).find(".fr-element").length && (a = w.el),
                          r += a.innerHTML
                      }
                  } else
              ...
              insert: function M(e, t, n) {
                  ...
                  0 === e.indexOf('<i class="fa ') && (r = "<span>&nbsp;".concat(r, "</span>")),
                  ...
                  w.node.isEmpty(w.el) && !w.opts.keepFormatOnDelete && f(r))
                      w.opts.trackChangesEnabled ? w.track_changes.pasteInEmptyEdior(r) : w.el.innerHTML = r;
                  else {
                      (function s() {
                      ...
                      if (o)
                          if (w.opts.trackChangesEnabled)
                              w.track_changes.pasteInEdior(r);
                          else {
                              ...
                              if ((f(r) || n) && (w.node.deepestParent(o) || i && "LI" === i.tagName)) {
                                  if (i && "LI" === i.tagName && (r = function l(e) {
                                      ...
                                      for (var n = t.querySelectorAll(":scope > ".concat(w.html.defaultTag())), r = n.length - 1; 0 <= r; r--) {
                                          var o = n[r];
                                          w.node.isBlock(o.previousSibling) || (o.previousSibling && !w.node.isEmpty(o) && u("<br>").insertAfter(o.previousSibling),
                                          o.outerHTML = o.innerHTML)
                                      }
                                      return t.innerHTML
                                  }(r)),
              ...
              unwrap: function A() {
                  w.$el.find("div.fr-temp-div").each(function() {
                      this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && u(this).before("<br>"),
                      u(this).attr("data-empty") || !this.nextSibling || w.node.isBlock(this.nextSibling) && !u(this.nextSibling).hasClass("fr-temp-div") ? u(this).replaceWith(u(this).html()) : u(this).replaceWith("".concat(u(this).html(), "<br>"))
                  }),
              ...
              _init: function R() {
                  w.events.$on(w.$el, "mousemove", "span.fr-word-select", function(e) {
                      ...
                      n.selectNodeContents(e.target),
                      t.removeAllRanges(),
                      t.addRange(n)
                  }),
                  w.$wp && (w.events.on("mouseup", L),
                  w.events.on("keydown", L),
      ...
      V.MODULES.keys = function(g) {
          var C, n, r, a = g.$, m = !1;
          function v(e) {
              if (g.selection.isCollapsed())
                  if (["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) < 0 && g.cursor.backspace(),
                  g.helpers.isIOS()) {
                      var t = g.selection.ranges(0);
                      t.deleteContents(),
                      t.insertNode(document.createTextNode("\u200b")),
                      g.selection.get().modify("move", "forward", "character")
                  } else
          ...
          function b(e) {
              ["INPUT", "BUTTON", "TEXTAREA"].indexOf(e.target && e.target.tagName) < 0 && e.preventDefault(),
              e.stopPropagation(),
              "" !== g.selection.text() || g.selection.element().hasAttribute("contenteditable") && "false" === g.selection.element().getAttribute("contenteditable") || !g.selection.isCollapsed() && "IMG" == g.selection.element().tagName ? g.selection.remove() : g.cursor.del(),
              g.placeholder.refresh()
          }
          function e() {
              if (g.browser.mozilla && g.selection.isCollapsed() && !m) {
                  var e = g.selection.ranges(0)
                    , t = e.startContainer
                    , n = e.startOffset;
                  t && t.nodeType === Node.TEXT_NODE && n <= t.textContent.length && 0 < n && 32 === t.textContent.charCodeAt(n - 1) && (g.selection.save(),
                  g.spaces.normalize(),
                  g.selection.restore())
              }
          }
          function t() {
              g.selection.isFull() && setTimeout(function() {
                  var e = g.html.defaultTag();
                  e ? g.$el.html("<".concat(e, ">").concat(V.MARKERS, "<br/></").concat(e, ">")) : g.$el.html("".concat(V.MARKERS, "<br/>")),
                  g.selection.restore(),
                  g.placeholder.refresh(),
          ...
          function E(e, t) {
              ...
              if (e.parentElement && (-1 < e.innerHTML.indexOf("<span") || -1 < e.parentElement.innerHTML.indexOf("<span") || n && -1 < e.parentElement.parentElement.innerHTML.indexOf("<span")) && (e.classList.contains("fr-img-space-wrap") || e.parentElement.classList.contains("fr-img-space-wrap") || n && e.parentElement.parentElement.classList.contains("fr-img-space-wrap"))) {
                  if (a(e.parentElement).is("p")) {
                      var r = e.parentElement.innerHTML;
                      return (r = r.replace(/<br>/g, "")).length < 1 ? e.parentElement.insertAdjacentHTML("afterbegin", "&nbsp;") : "&nbsp;" != r && " " != r && "Backspace" == t.key ? v(t) : "&nbsp;" != r && " " != r && "Delete" == t.key && b(t),
                      !0
                  }
                  if (a(e).is("p")) {
                      var o = e.innerHTML.replace(/<br>/g, "");
                      return o.length < 1 ? e.insertAdjacentHTML("afterbegin", "&nbsp;") : "&nbsp;" != o && " " != o && "Backspace" == t.key ? v(t) : "&nbsp;" != o && " " != o && "Delete" == t.key && b(t),
                      !0
                  }
              }
              return !1
          ...
          function s(e) {
              ...
              if (t && 0 <= ["INPUT", "TEXTAREA"].indexOf(t.tagName))
                  return !0;
              if (e && N(e.which)) {
                  var n = g.selection.element()
                    , r = g.selection.get()
                    , o = r.anchorNode
                    , i = r.anchorOffset;
                  if (o.nodeType === Node.TEXT_NODE && 0 < i && 1 < o.textContent.length && 8203 === o.textContent.charCodeAt(i)) {
                      y(n);
                      var a = g.doc.createRange();
                      g.selection.get().removeAllRanges(),
                      a.setStart(o, i - 1),
                      a.setEnd(o, i - 1),
                      g.selection.get().addRange(a)
                  }
                  return !0
              }
              ...
              if (16 === s)
                  return !0;
              if ((C = s) === V.KEYCODE.IME)
                  return m = !0;
              if (m = !1,
              S(e))
                  return !0;
              var l = T(s) && !S(e) && !e.altKey
                , c = s === V.KEYCODE.BACKSPACE || s === V.KEYCODE.DELETE;
              if ((g.selection.isFull() && !g.opts.keepFormatOnDelete && !g.placeholder.isVisible() || c && g.placeholder.isVisible() && g.opts.keepFormatOnDelete) && (l || c) && (L(),
              !T(s)))
                  return e.preventDefault(),
                  !0;
              if (s === V.KEYCODE.ENTER)
                  !g.helpers.isIOS() && e.shiftKey || t.classList.contains("fr-inner") || t.parentElement.classList.contains("fr-inner") ? function d(e) {
                      e.preventDefault(),
                      e.stopPropagation(),
                      g.opts.multiLine && (g.selection.isCollapsed() || g.selection.remove(),
                      g.cursor.enter(!0))
                  }(e) : function f(e) {
                      g.opts.multiLine ? (g.helpers.isIOS() || (e.preventDefault(),
                      e.stopPropagation()),
                      g.selection.isCollapsed() || g.selection.remove(),
                      g.cursor.enter()) : (e.preventDefault(),
                      e.stopPropagation())
                  }(e);
              else if (s === V.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey))
                  !function p() {
                      setTimeout(function() {
                          g.events.disableBlur(),
                          g.events.focus()
              ...
              else if (s !== V.KEYCODE.BACKSPACE || S(e) || e.altKey)
                  if (s !== V.KEYCODE.DELETE || S(e) || e.altKey || e.shiftKey)
                      s === V.KEYCODE.SPACE ? function h(e) {
                          var t = g.selection.element();
                          if (!g.helpers.isMobile() && t && "A" === t.tagName) {
                              e.preventDefault(),
                              e.stopPropagation(),
                              g.selection.isCollapsed() || g.selection.remove();
                              var n = g.markers.insert();
                              if (n) {
                      ...
                      }(e) : s === V.KEYCODE.TAB ? function u(e) {
                          if (0 < g.opts.tabSpaces)
                              if (g.selection.isCollapsed()) {
                                  g.undo.saveStep(),
                                  e.preventDefault(),
                                  e.stopPropagation();
                                  for (var t = "", n = 0; n < g.opts.tabSpaces; n++)
                                      t += "&nbsp;";
                                  g.html.insert(t),
                                  g.placeholder.refresh(),
                                  g.undo.saveStep()
                                  ...
                                  e.preventDefault(),
                                  e.stopPropagation(),
                                  e.shiftKey ? g.commands.outdent() : g.commands.indent()
                      }(e) : S(e) || !T(e.which) || g.selection.isCollapsed() || e.ctrlKey || e.altKey || g.browser.mozilla || g.selection.remove();
                  else {
                      if (E(t, e))
                          return e.preventDefault(),
                          void e.stopPropagation();
                      g.placeholder.isVisible() ? (g.opts.keepFormatOnDelete || L(),
                      e.preventDefault(),
          ...
          function y(e) {
              var t = e;
              -1 < ["STRONG", "U", "EM"].indexOf(e.nodeName) && e.parentNode && (t = e.parentNode);
              for (var n = g.doc.createTreeWalker(t, NodeFilter.SHOW_TEXT, g.node.filter(function(e) {
          ...
          function l() {
              if (!g.$wp)
                  return !0;
              var e;
              if (g.opts.height || g.opts.heightMax) {
                  e = g.position.getBoundingRect().top,
                  (g.helpers.isIOS() || g.helpers.isAndroid()) && (e -= g.helpers.scrollTop()),
                  g.opts.iframe && (e += g.$iframe.offset().top);
                  var t = g.selection.blocks()
                    , n = null;
                  if (t && 0 < t.length && t[0].offsetTop && (n = t[0].getBoundingClientRect().top,
                  3 === g.selection.get().anchorNode.nodeType)) {
                      var r = g.doc.createRange()
                        , o = g.selection.get().anchorNode
                        , i = g.selection.get().anchorOffset;
                      r.selectNode(o),
                      r.setStart(o, i),
                      n = r.getBoundingClientRect().top
                  }
                  !g.opts.iframe && e > g.$wp.offset().top - g.helpers.scrollTop() + g.$wp.height() - 20 ? g.$wp.scrollTop(e + g.$wp.scrollTop() - (g.$wp.height() + g.$wp.offset().top) + g.helpers.scrollTop() + 20) : g.opts.iframe && n && (g.$wp.scrollTop() > n ? g.$wp.scrollTop(n - 20) : n > g.$wp.scrollTop() + g.$wp.height() && g.$wp.scrollTop(n))
              } else
                  e = g.position.getBoundingRect().top,
                  g.opts.toolbarBottom && (e += g.opts.toolbarStickyOffset),
                  (g.helpers.isIOS() || g.helpers.isAndroid()) && (e -= g.helpers.scrollTop()),
                  g.opts.iframe && (e += g.$iframe.offset().top,
                  e -= g.helpers.scrollTop()),
                  (e += g.opts.toolbarStickyOffset) > g.o_win.innerHeight - 20 && a(g.o_win).scrollTop(e + g.helpers.scrollTop() - g.o_win.innerHeight + 20),
                  e = g.position.getBoundingRect().top,
                  g.opts.toolbarBottom || (e -= g.opts.toolbarStickyOffset),
                  (g.helpers.isIOS() || g.helpers.isAndroid()) && (e -= g.helpers.scrollTop()),
                  g.opts.iframe && (e += g.$iframe.offset().top,
                  e -= g.helpers.scrollTop()),
                  e < 100 && a(g.o_win).scrollTop(e + g.helpers.scrollTop() - 100)
          }
          function c(e) {
              var t = g.selection.element();
              if (t && 0 <= ["INPUT", "TEXTAREA"].indexOf(t.tagName))
                  return !0;
              if (e && 0 === e.which && C && (e.which = C),
              g.helpers.isAndroid() && g.browser.mozilla)
                  return !0;
              if (m)
                  return !1;
              if (e && g.helpers.isIOS() && e.which === V.KEYCODE.ENTER && g.doc.execCommand("undo"),
              ...
              if (e && N(e.which))
                  return !0;
              if (e && !g.helpers.isIOS() && (e.which === V.KEYCODE.ENTER || e.which === V.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !g.browser.msie))
                  try {
                      l()
                  } catch (i) {}
              var n = g.selection.element();
              ...
              }(n) && !g.node.hasClass(n, "fr-marker") && "IFRAME" !== n.tagName && function s(e) {
                  return !g.helpers.isIOS() || 0 === ((e.textContent || "").match(/[\u3041-\u3096\u30A0-\u30FF\u4E00-\u9FFF\u3130-\u318F\uAC00-\uD7AF]/gi) || []).length
              }(n)) {
                  g.selection.save();
                  var r = g.$el.find(".fr-marker")[1]
                    , o = (e || "").which;
                  g.opts.enter === V.ENTER_BR && n === g.$el.get(0) && 8 === o && null == r.nextSibling || y(n),
                  g.selection.restore()
              }
          }
          function S(e) {
          ...
          function d(e) {
              var t = e.which;
              if (S(e) || 37 <= t && t <= 40 || !T(t) && t !== V.KEYCODE.DELETE && t !== V.KEYCODE.BACKSPACE && t !== V.KEYCODE.ENTER && t !== V.KEYCODE.IME)
                  return !0;
              n || (r = g.snapshot.get(),
              ...
              n = setTimeout(function() {
                  n = null,
                  g.undo.saveStep()
              }, Math.max(250, g.opts.typingTimer))
          }
          function f(e) {
              var t = e.which;
              if (S(e) || 37 <= t && t <= 40)
                  return !0;
              r && n ? (g.undo.saveStep(r),
              r = null) : void 0 !== t && 0 !== t || r || n || g.undo.saveStep()
          }
          function p(e) {
              if (e && "BR" === e.tagName)
                  return !1;
              try {
                  return 0 === (e.textContent || "").length && e.querySelector && !e.querySelector(":scope > br") || e.childNodes && 1 === e.childNodes.length && e.childNodes[0].getAttribute && ("false" === e.childNodes[0].getAttribute("contenteditable") || g.node.hasClass(e.childNodes[0], "fr-img-caption"))
              } catch (t) {
                  return !1
              }
          }
          function h(e) {
              var t = g.el.childNodes
                , n = g.html.defaultTag()
                , r = g.node.blockParent(g.selection.blocks()[0]);
              return r && "TR" == r.tagName && r.getAttribute("contenteditable") == undefined && (r = r.closest("table")),
              !g.node.isEditable(e.target) || r && "false" === r.getAttribute("contenteditable") ? g.toolbar.disable() : g.toolbar.enable(),
              !(!e.target || e.target === g.el) || (0 === t.length || void (t[0].offsetHeight + t[0].offsetTop <= e.offsetY ? p(t[t.length - 1]) && (n ? g.$el.append("<".concat(n, ">").concat(V.MARKERS, "<br></").concat(n, ">")) : g.$el.append("".concat(V.MARKERS, "<br>")),
              g.selection.restore(),
              l()) : e.offsetY <= 10 && p(t[0]) && (n ? g.$el.prepend("<".concat(n, ">").concat(V.MARKERS, "<br></").concat(n, ">")) : g.$el.prepend("".concat(V.MARKERS, "<br>")),
              g.selection.restore(),
              l())))
          }
          function u() {
          ...
          return {
              _init: function M() {
                  g.events.on("keydown", d),
                  g.events.on("input", e),
                  g.events.on("mousedown", i),
                  g.events.on("keyup input", f),
                  g.events.on("keypress", o),
                  g.events.on("keydown", s),
                  g.events.on("keyup", c),
                  g.events.on("destroy", u),
                  g.events.on("html.inserted", c),
                  g.events.on("cut", t),
                  g.opts.multiLine && g.events.on("click", h),
                  g.events.on("initialized", function() {
                      g.el.addEventListener("compositionstart", function() {
                          if (g.selection.isCollapsed()) {
                              var e = g.selection.ranges(0)
                                , t = e.startContainer
                                , n = e.startOffset;
                              if (t && t.nodeType === Node.TEXT_NODE && n <= t.textContent.length && 0 < n && 8203 === t.textContent.charCodeAt(n - 1)) {
                                  g.selection.save();
                                  var r = g.$el.find(".fr-marker");
                                  a(r.get(0).previousSibling).before(V.HAIR_SPACE),
                                  r.get(0).previousSibling.textContent = r.get(0).previousSibling.textContent.replace(/\u200B/gi, ""),
                                  g.selection.restore()
                              }
                          }
                      }),
                      g.el.addEventListener("compositionend", function() {
                          if (g.selection.isCollapsed()) {
                              var e = g.selection.ranges(0)
                                , t = e.startContainer
                                , n = e.startOffset;
      ...
      V.MODULES.paste = function(A) {
          ...
          function n(e, t) {
              try {
                  A.win.localStorage.setItem("fr-copied-html", e),
                  A.win.localStorage.setItem("fr-copied-text", t)
              } catch (n) {}
          }
          function e(e) {
              var t = A.html.getSelected();
              n(t, k(A.doc.createElement("div")).html(t).text()),
              "cut" === e.type && (A.undo.saveStep(),
              setTimeout(function() {
                  A.selection.save(),
                  A.html.wrap(),
                  A.selection.restore(),
          ...
          var c, r = !1;
          function t(e) {
              if ("INPUT" === (c = e).target.nodeName && "text" === e.target.type)
                  return !0;
              if (A.edit.isDisabled())
                  return !1;
              if (d(e.target))
                  return !1;
              if (r)
              ...
              e && e.clipboardData && e.clipboardData.getData) && ((e.clipboardData || window.clipboardData).getData("text/html") || "").match('content="Microsoft OneNote'))
                  return !1;
              if (!1 === A.events.trigger("paste.before", [e]))
                  return e.preventDefault(),
                  !1;
              if (e && e.clipboardData && e.clipboardData.getData) {
                  var t = "";
                  if (O = e.clipboardData.types,
                  A.helpers.isArray(O))
              ...
              return function a() {
                  ...
                  l) {
                      l.html("");
                      var e = f(A.selection.get().anchorNode) + A.$wp.offset().top;
                      l.css("top", e),
                      A.browser.edge && A.opts.iframe && A.$el.append(l)
                  } else {
                      var t = document.getElementsByTagName("BODY")[0]
                        , n = window.getComputedStyle(t).transform;
                      if ("none" !== n) {
                          var r = f(A.selection.get().anchorNode) + A.$wp.offset().top;
                          l = k('<div contenteditable="true" style="position: fixed; top: ' + r + 'px; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>')
                      } else
                          l = k('<div contenteditable="true" style="position: fixed; top: 0; left: -9999px; height: 100%; width: 0; word-break: break-all; overflow:hidden; z-index: 2147483647; line-height: 140%; -moz-user-select: text; -webkit-user-select: text; -ms-user-select: text; user-select: text;" tabIndex="-1"></div>');
                      A.browser.webkit || A.browser.mozilla ? ("none" === n && l.css("top", A.$sc.scrollTop()),
                      A.$el.after(l)) : A.browser.edge && A.opts.iframe ? A.$el.append(l) : A.$box.after(l),
                      A.events.on("destroy", function() {
                          l.remove()
                      })
                  }
                  var o;
                  A.helpers.isIOS() && A.$sc && (o = A.$sc.scrollTop());
                  A.opts.iframe && A.$el.attr("contenteditable", "false");
                  A.helpers.isIOS() && A.$sc && A.$sc.scrollTop(o);
                  var i = c.clipboardData.getData("Text");
                  4e5 < i.length ? (c.preventDefault(),
                  i = p(i),
                  l.get(0).innerHTML = i,
                  setTimeout(function() {
                      A.win.setTimeout(h, 1)
                  }, 0)) : (l.focus(),
                  A.win.setTimeout(h, 1))
              }(),
              !1
          ...
          function o(e) {
              ...
              if (e && e.dataTransfer && e.dataTransfer.getData) {
                  ...
                  A.helpers.isArray(O))
                      ...
                      t = O;
                  if (s = "",
                  /text\/rtf/.test(t) && (i = e.dataTransfer.getData("text/rtf")),
                  /text\/html/.test(t) ? s = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && A.browser.safari ? s = i : /text\/plain/.test(t) && !this.browser.mozilla && (s = A.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")),
                  "" !== s) {
                      A.keys.forceUndo(),
                      w = A.snapshot.get(),
                      A.selection.save(),
                      A.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
                      var r = A.markers.insertAtPoint(e);
                      if (A.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"),
                      A.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"),
                      A.selection.restore(),
                      A.selection.remove(),
                      A.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"),
                      !1 !== r) {
                          var o = A.el.querySelector(".fr-marker");
                          return k(o).replaceWith(V.MARKERS),
                          A.selection.restore(),
                          h(),
                          e.preventDefault && (e.stopPropagation(),
                          e.preventDefault()),
          ...
          function f(e) {
              return e.nodeType === Node.TEXT_NODE ? e.parentNode.offsetTop : e.offsetTop
          }
          function p(e) {
              var t = A.html.defaultTag() || "p"
                , n = "</".concat(t, "><").concat(t, ">");
              return A.opts.enter === V.ENTER_BR ? n = "<br />" : e = "<".concat(t, ">") + e,
              e.replace(/\n{2,}/g, n)
          }
          function h() {
              A.opts.iframe && A.$el.attr("contenteditable", "true"),
              A.browser.edge && A.opts.iframe && A.$box.after(l),
              w || (A.keys.forceUndo(),
              w = A.snapshot.get()),
              s || (s = l.get(0).innerHTML,
              x = l.text(),
              A.$el[0].setAttribute("plainpaste", !0),
              A.selection.restore(),
              A.events.enableBlur());
              var e = s.match(/(class="?Mso|class='?Mso|class="?Xl|class='?Xl|class=Xl|style="[^"]*\bmso-|style='[^']*\bmso-|w:WordDocument|LibreOffice)/gi)
                , t = A.events.chainTrigger("paste.beforeCleanup", s);
              if (t && "string" == typeof t) {
                  s = t;
                  var n = (new DOMParser).parseFromString(t, "text/html");
                  x = n.body.innerText
              }
              (!e || e && !1 !== A.events.trigger("paste.wordPaste", [s])) && a(s, e)
          }
          function $(e) {
              for (var t = "", n = 0; n++ < e; )
                  t += "&nbsp;";
          ...
          function a(e, t, n) {
              ...
              if (0 <= e.toLowerCase().indexOf("<body")) {
                  ...
                  e = (e = (e = a + e.replace(/[.\s\S\w\W<>]*<body[^>]*>[\s]*([.\s\S\w\W<>]*)[\s]*<\/body>[.\s\S\w\W<>]*/gi, "$1")).replace(/<pre(?:[\w\W]*?)>(?:[\w\W]*?)<\/pre>/g, function(e) {
                      return e.replace(/\n/g, "<br />")
                  })).replace(/ \n/g, " ").replace(/\n /g, " ").replace(/([^>])\n([^<])/g, "$1 $2")
              }
              var s = !1;
              ...
              s = !0),
              (0 <= e.indexOf('content="Sheets"') || 0 <= e.indexOf("google-sheets-html-origin")) && (e = e.replace(/width:0px;/g, ""));
              var l = !1;
              if (!t)
                  if ((l = function y() {
                      var e = null;
                      ...
                      return !(!e || !x || O && -1 === O.indexOf("text/html") || x.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") !== e.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") && x.replace(/\s/g, "") !== e.replace(/\s/g, ""))
                  }()) && (e = A.win.localStorage.getItem("fr-copied-html")),
                  l)
                      e = A.clean.html(e, A.opts.pasteDeniedTags, A.opts.pasteDeniedAttrs);
                  else {
                      var c = A.opts.htmlAllowedStyleProps;
                      A.opts.htmlAllowedStyleProps = A.opts.pasteAllowedStyleProps,
                      A.opts.htmlAllowComments = !1,
                      e = (e = (e = e.replace(/<span class="Apple-tab-span">\s*<\/span>/g, $(A.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) {
                          return $(t.length * (A.opts.tabSpaces || 4))
                      })).replace(/\t/g, $(A.opts.tabSpaces || 4)),
                      e = A.clean.html(e, A.opts.pasteDeniedTags, A.opts.pasteDeniedAttrs),
                      A.opts.htmlAllowedStyleProps = c,
                      A.opts.htmlAllowComments = !0,
                      A.html.defaultTag() && "div" === A.html.defaultTag() || (e = H(e)),
                      e = (e = e.replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
                  }
              ...
              e = H(e = function S(e) {
                  ...
                  e = (e = (e = A.clean.html(e, A.opts.pasteDeniedTags, A.opts.pasteDeniedAttrs)).replace(/<a>(.[^<]+)<\/a>/gi, "$1")).replace(/<br> */g, "<br>");
                  ...
                  return A.html.cleanBlankSpaces(i),
                  e = i.innerHTML
              }(e))),
              A.opts.pastePlain && (e = function N(e) {
                  var t, n = null, r = A.doc.createElement("div");
                  r.innerHTML = e;
                  var o = r.querySelectorAll("p, div, h1, h2, h3, h4, h5, h6, pre, blockquote");
                  for (t = 0; t < o.length; t++)
                      if ((n = o[t]).innerText) {
                          var i = A.clean.html("<".concat(A.html.defaultTag() || "DIV", ">").concat(n.innerText, "</").concat(A.html.defaultTag() || "DIV", ">"));
                          n.outerHTML = i
                      }
              ...
              if (A.$el[0].removeAttribute("plainpaste", !0),
              "string" == typeof d && (e = d),
              "" !== e) {
                  var f = A.o_doc.createElement("div");
                  0 <= (f.innerHTML = e).indexOf("<body>") ? (A.html.cleanBlankSpaces(f),
                  A.spaces.normalize(f, !0)) : A.spaces.normalize(f);
                  ...
                  var C = A.selection.element()
                    , m = !1;
                  if (C && k(C).parentsUntil(A.el, "ul, ol").length && (m = !0),
                  m) {
                      var v = f.children;
                  ...
                  if (A.opts.enter === V.ENTER_BR)
                      for (r = (o = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--)
                          0 === (i = o[r]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !A.node.isEmpty(i) ? "<br>" : ""));
                      ...
                      A.opts.enter === V.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
                  if (f.childNodes[0]instanceof HTMLHeadingElement && A.selection.element().tagName === f.childNodes[0].tagName && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML),
                  f.children && 0 < f.children.length)
                      if (A.opts.trackChangesEnabled)
                          for (var E = 0; E < f.children.length; E++)
                              f.children[E].setAttribute("id", "isPasted");
                      else
                          f.children[0].setAttribute("id", "isPasted");
                  e = (e = f.innerHTML).replace(/\n/g, ""),
                  l && (e = function T(e) {
          ...
          function H(e) {
              var t, n = A.o_doc.createElement("div");
              n.innerHTML = e;
              for (var r = u(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length; ) {
                  var o = r[r.length - 1];
                  if (A.html.defaultTag() && "div" !== A.html.defaultTag())
                      o.querySelector(A.html.blockTagsQuery()) ? o.outerHTML = o.innerHTML : o.outerHTML = "<".concat(A.html.defaultTag(), ">").concat(o.innerHTML, "</").concat(A.html.defaultTag(), ">");
                  else {
                  ...
                  r = u(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])")))
              }
              for (r = u(Array.prototype.slice.call(n.querySelectorAll("div:not([style])"))); r.length; ) {
                  for (t = 0; t < r.length; t++) {
                      var a = r[t]
                        , s = a.innerHTML.replace(/\u0009/gi, "").trim();
                      a.outerHTML = s
                  }
                  r = u(Array.prototype.slice.call(n.querySelectorAll("div:not([style])")))
              }
              return n.innerHTML
          }
          function g() {
              A.el.removeEventListener("copy", e),
              A.el.removeEventListener("cut", e),
              A.el.removeEventListener("paste", t)
          }
          return {
              _init: function C() {
                  A.el.addEventListener("copy", e),
                  A.el.addEventListener("cut", e),
                  A.el.addEventListener("paste", t, {
                      capture: !0
                  }),
                  A.events.on("drop", o),
                  A.browser.msie && A.browser.version < 11 && (A.events.on("mouseup", function(e) {
                      2 === e.button && (setTimeout(function() {
                          r = !1
                      }, 50),
                      r = !0)
                  }, !0),
                  A.events.on("beforepaste", t)),
                  A.events.on("destroy", g)
              },
              cleanEmptyTagsAndDivs: H,
              getRtfClipboard: function m() {
                  return i
              },
              saveCopiedText: n,
              clean: a,
          ...
          return {
              ...
              saveStep: function f(e) {
                  if (!(!n.undo_stack || n.undoing || n.el.querySelector(".fr-marker") || n.el.querySelector(".fr-marker") && n.opts.iframe && n.markdown && !n.markdown.isEnabled()))
                      if (void 0 === e) {
                          if ((e = n.snapshot.get()) && e.html && n.undo_stack[n.undo_stack.length - 1] && e.html === n.undo_stack[n.undo_stack.length - 1].html)
                              return;
                          ...
                          }(t, e.html) || (n.events.trigger("contentChanged"),
                          t = e.html))
                      } else
                          r(),
      ...
      V.MODULES.size = function(r) {
          function e() {
              o(),
              r.opts.height && r.$el.css("minHeight", r.opts.height - r.helpers.getPX(r.$el.css("padding-top")) - r.helpers.getPX(r.$el.css("padding-bottom")));
              var e = !1;
              if (r.opts.fullPage)
              ...
              r.opts.fullPage && e && (r.opts.heightMin && r.$iframe.css("minHeight", r.opts.heightMin),
              r.opts.heightMax && r.$iframe.css("maxHeight", r.opts.heightMax),
              r.$el.css("overflow-y", "auto")),
              r.opts.iframe && r.markdown && r.markdown.isEnabled() ? r.$iframe.height(r.$wp.parent().outerHeight(!0)) : r.$iframe.height(r.$el.outerHeight(!0))
          }
          function o() {
              r.opts.heightMin ? r.$el.css("minHeight", r.opts.heightMin) : r.$el.css("minHeight", ""),
              r.opts.heightMax ? (r.$wp.css("maxHeight", r.opts.heightMax),
              r.$wp.css("overflow", "auto")) : (r.$wp.css("maxHeight", ""),
              r.$wp.css("overflow", "")),
              r.opts.height ? (r.$wp.css("height", r.opts.height),
              r.$wp.css("overflow", "auto"),
              r.$el.css("minHeight", r.opts.height - r.helpers.getPX(r.$el.css("padding-top")) - r.helpers.getPX(r.$el.css("padding-bottom")))) : (r.$wp.css("height", ""),
              r.opts.heightMin || r.$el.css("minHeight", ""),
              r.opts.heightMax || r.$wp.css("overflow", "")),
              r.opts.width && r.$box.width(r.opts.width)
          }
          return {
              _init: function t() {
                  if (!r.$wp)
                      return !1;
                  o(),
                  r.$iframe && (r.events.on("keyup keydown", function() {
                      setTimeout(e, 0)
                  }, !0),
                  r.events.on("commands.after html.set init initialized paste.after", e))
              },
              syncIframe: e,
              refresh: o
          }
      ...
      V.MODULES.core = function(l) {
          var c = l.$;
          function n() {
              if (l.$box.addClass("fr-box".concat(l.opts.editorClass ? " ".concat(l.opts.editorClass) : "")),
              l.$box.attr("role", "application"),
              l.$wp.addClass("fr-wrapper"),
              l.opts.documentReady && l.$box.addClass("fr-document"),
              function a() {
                  l.opts.iframe || l.$el.addClass("fr-element fr-view"),
                  (l.opts.height && l.opts.height < window.innerHeight || l.opts.heightMax && l.opts.heightMax < window.innerHeight) && l.$el.addClass("fr-element-scroll-visible")
              }(),
              l.opts.iframe) {
                  l.$iframe.addClass("fr-iframe"),
                  l.$el.addClass("fr-view");
                  for (var e = 0; e < l.o_doc.styleSheets.length; e++) {
                      var t = void 0
                        , n = !1;
                      try {
                          t = l.o_doc.styleSheets[e].cssRules
                      } catch (s) {}
                      if (l.o_doc.styleSheets[e].href && (-1 < l.o_doc.styleSheets[e].href.indexOf("codemirror") || -1 < l.o_doc.styleSheets[e].href.indexOf("font-awesome")) && (n = !(t = null)),
                      t)
                          for (var r = 0, o = t.length; r < o; r++)
                              if (!t[r].selectorText || 0 !== t[r].selectorText.indexOf(".fr-view") && 0 !== t[r].selectorText.indexOf(".fr-element") && 0 !== t[r].selectorText.indexOf(".fr-box.fr-basic .fr-element") && 0 !== t[r].selectorText.indexOf(".fr-markdown-view") && 0 !== t[r].selectorText.indexOf(".fr-markdown-editor") && 0 !== t[r].selectorText.indexOf(".fr-wrapper-markdown") && 0 !== t[r].selectorText.indexOf(".gutter-horizontal") && 0 !== t[r].selectorText.indexOf(".e-resize-handler"))
                                  try {
                                      n && l.o_doc.styleSheets[e].href && t[r].selectorText && (l.opts.iframeStyle += "".concat(t[r].selectorText, "{").concat(t[r].style.cssText, "}"),
                                      n = !1)
                                  } catch (s) {}
                              else
                                  0 < t[r].style.cssText.length && (0 === t[r].selectorText.indexOf(".fr-box.fr-basic .fr-element") && (l.opts.iframeStyle += "".concat(t[r].selectorText, "{").concat(t[r].style.cssText, "}")),
                                  0 === t[r].selectorText.indexOf(".fr-view") ? l.opts.iframeStyle += "".concat(t[r].selectorText.replace(/\.fr-view/g, "body"), "{").concat(t[r].style.cssText, "}") : l.opts.iframeStyle += "".concat(t[r].selectorText.replace(/\.fr-element/g, "body"), "{").concat(t[r].style.cssText, "}"));
                      else if (l.o_doc.styleSheets[e].href && (-1 < l.o_doc.styleSheets[e].href.indexOf("codemirror") || -1 < l.o_doc.styleSheets[e].href.indexOf("font-awesome") || -1 < l.o_doc.styleSheets[e].href.indexOf("froala-editor"))) {
                          var i = c("<link rel='stylesheet' type='text/css' href='".concat(l.o_doc.styleSheets[e].href, "'>"));
                          l.$head.append(i)
                      }
                  }
              }
              "auto" !== l.opts.direction && l.$box.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(l.opts.direction)),
              l.$el.attr("dir", l.opts.direction),
              l.$wp.attr("dir", l.opts.direction),
              1 < l.opts.zIndex && l.$box.css("z-index", l.opts.zIndex),
              l.opts.theme && l.$box.addClass("".concat(l.opts.theme, "-theme")),
              l.opts.tabIndex = l.opts.tabIndex || l.$oel.attr("tabIndex"),
              l.opts.tabIndex && l.$el.attr("tabIndex", l.opts.tabIndex)
          }
          return {
              _init: function r() {
                  if (V.INSTANCES.push(l),
                  function e() {
                      l.drag_support = {
                          filereader: "undefined" != typeof FileReader,
                          formdata: Boolean(l.win.FormData),
                          progress: "upload"in new XMLHttpRequest
                      }
                  }(),
                  l.$wp) {
                      n(),
                      l.html.set(l._original_html),
                      l.$el.attr("spellcheck", l.opts.spellcheck),
                      l.helpers.isMobile() && (l.$el.attr("autocomplete", l.opts.spellcheck ? "on" : "off"),
                      l.$el.attr("autocorrect", l.opts.spellcheck ? "on" : "off"),
                      l.$el.attr("autocapitalize", l.opts.spellcheck ? "on" : "off")),
                      l.opts.disableRightClick && l.events.$on(l.$el, "contextmenu", function(e) {
                          if (2 === e.button)
                              return e.preventDefault(),
                              e.stopPropagation(),
                              !1
                      ...
                      try {
                          l.doc.execCommand("styleWithCSS", !1, !1)
                      } catch (t) {}
                  }
                  "TEXTAREA" === l.$oel.get(0).tagName && (l.events.on("contentChanged", function() {
                      l.$oel.val(l.html.get())
                  }),
                  l.events.on("form.submit", function() {
                      l.$oel.val(l.html.get())
                  }),
                  l.events.on("form.reset", function() {
                      l.html.set(l._original_html)
                  }),
                  l.$oel.val(l.html.get())),
                  l.helpers.isIOS() && l.events.$on(l.$doc, "selectionchange", function() {
                      l.$doc.get(0).hasFocus() || l.$win.get(0).focus()
                  }),
                  l.events.trigger("init"),
                  l.opts.autofocus && !l.opts.initOnClick && l.$wp && l.events.on("initialized", function() {
                      l.events.focus(!0)
                  })
              },
              destroy: function t(e) {
                  "TEXTAREA" === l.$oel.get(0).tagName && l.$oel.val(e),
                  l.$box && l.$box.removeAttr("role"),
                  l.$wp && ("TEXTAREA" === l.$oel.get(0).tagName ? (l.$el.html(""),
                  l.$wp.html(""),
                  l.$box.replaceWith(l.$oel),
                  l.$oel.show()) : (l.$wp.replaceWith(e),
                  l.$el.html(""),
                  l.$box.removeClass("fr-view fr-ltr fr-box ".concat(l.opts.editorClass || "")),
                  l.opts.theme && l.$box.addClass("".concat(l.opts.theme, "-theme")))),
                  this.$wp = null,
                  this.$el = null,
                  this.el = null,
              ...
              isEmpty: function e() {
                  return l.node.isEmpty(l.el)
              },
              getXHR: function o(e, t) {
                  var n = new XMLHttpRequest;
                  for (var r in n.open(t, e, !0),
                  l.opts.requestWithCredentials && (n.withCredentials = !0),
                  l.opts.requestHeaders)
                      Object.prototype.hasOwnProperty.call(l.opts.requestHeaders, r) && n.setRequestHeader(r, l.opts.requestHeaders[r]);
                  return n
              },
              injectStyle: function i(e) {
                  if (l.opts.iframe) {
                      l.$head.find("style[data-fr-style], link[data-fr-style]").remove(),
                      l.$head.append('<style data-fr-style="true">'.concat(e, "</style>"));
                      for (var t = 0; t < l.opts.iframeStyleFiles.length; t++) {
                          var n = c('<link data-fr-style="true" rel="stylesheet" href="'.concat(l.opts.iframeStyleFiles[t], '">'));
                          n.get(0).addEventListener("load", l.size.syncIframe),
                          l.$head.append(n)
                      }
                  }
              },
              hasFocus: function a() {
                  return l.browser.mozilla && l.helpers.isMobile() ? l.selection.inEditor() : l.node.hasFocus(l.el) || 0 < l.$el.find("*:focus").length
              },
              sameInstance: function s(e) {
                  if (!e)
                      return !1;
      ...
      V.MODULES.popups = function(h) {
          ...
          var u, g = h.shared.popups;
          function C(e, t) {
              t.isVisible() || (t = h.$sc),
              t.is(g[e].data("container")) || (g[e].data("container", t),
              t.append(g[e]))
          }
          function o(e) {
              var t;
              ...
              h.popups.get("filesManager.insert").removeClass("fr-height-auto"),
              ...
              e.find(".fr-upload-progress-layer").get(0).clientHeight + 10 < e.find(".fr-upload-progress").get(0).clientHeight && e.find(".fr-upload-progress").addClass("fr-height-auto"),
              400 < e[0].clientHeight && (e[0].childNodes[4].style.height = "".concat(e[0].clientHeight - (e[0].childNodes[0].clientHeight + e[0].childNodes[t].clientHeight) - 80, "px"))
          }
          var i = 2e3;
          function a() {
          ...
          function m(e) {
              return g[e] && h.node.hasClass(g[e], "fr-active") && h.core.sameInstance(g[e]) || !1
          }
          function v(e) {
              for (var t in g)
                  if (Object.prototype.hasOwnProperty.call(g, t) && m(t) && (void 0 === e || g[t].data("instance") === e))
                      return g[t];
              return !1
          }
          function n(e) {
              var t = null;
              if (t = "string" != typeof e ? e : g[e],
              "filesManager.insert" === e && h.filesManager !== undefined && h.filesManager.isChildWindowOpen())
                  return !1;
              if (t && h.node.hasClass(t, "fr-active") && (t.removeClass("fr-active fr-above"),
              h.events.trigger("popups.hide.".concat(e)),
              h.$tb && (1 < h.opts.zIndex ? h.$tb.css("zIndex", h.opts.zIndex + 1) : h.$tb.css("zIndex", "")),
              ...
              u))
                  for (var n = 0; n < u.length; n++)
                      d(u[n]).removeClass("fr-btn-active-popup")
          }
          function b(e) {
              for (var t in void 0 === e && (e = []),
              g)
                  Object.prototype.hasOwnProperty.call(g, t) && e.indexOf(t) < 0 && n(t)
          }
          function t() {
          ...
          function c(e, t) {
              var n, r = function c(e, t) {
                  ...
                  if (!n)
                      return null;
                  for (var r in "function" == typeof n && (n = n.apply(h)),
                  t)
                      Object.prototype.hasOwnProperty.call(t, r) && (n = n.replace("[_".concat(r.toUpperCase(), "_]"), t[r]));
                  return n
              }(e, t), o = d(h.doc.createElement("DIV"));
              if (!r)
                  return "filesManager.insert" === e ? o.addClass("fr-popup fr-files-manager fr-empty") : o.addClass("fr-popup fr-empty"),
                  (n = d("body").first()).append(o),
                  o.data("container", n),
                  g[e] = o;
              "filesManager.insert" === e ? o.addClass("fr-popup fr-files-manager".concat(h.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(h.opts.toolbarInline ? " fr-inline" : "")) : o.addClass("fr-popup".concat(h.helpers.isMobile() ? " fr-mobile" : " fr-desktop").concat(h.opts.toolbarInline ? " fr-inline" : "")),
              o.html(r),
              h.opts.theme && o.addClass("".concat(h.opts.theme, "-theme")),
              1 < h.opts.zIndex && (!h.opts.editInPopup && h.$tb ? h.$tb.css("z-index", h.opts.zIndex + 2) : o.css("z-index", h.opts.zIndex + 2)),
              "auto" !== h.opts.direction && o.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(h.opts.direction)),
              o.find("input, textarea").attr("dir", h.opts.direction).attr("disabled", "disabled"),
              (n = d("body").first()).append(o),
              o.data("container", n);
              ...
              return h.button.bindCommands(o, !1),
              o
          }
          function E(a) {
              var s = g[a];
              return {
                  _windowResize: function() {
                      var e = s.data("instance") || h;
                      if (!e.helpers.isMobile() && s.isVisible()) {
                          var t = s.find(".fr-file-progress-bar-layer");
                          if ("file.insert" === a && 0 < t.length && t.hasClass("fr-active")) {
                              var n = h.$tb.find('.fr-command[data-cmd="insertFile"]');
                              e.events.disableBlur();
                              var r = h.button.getPosition(n)
                                , o = r.left
                                , i = r.top;
                              h.position.at(o, i, g[a], 0),
                              e.events.enableBlur()
                          } else
                              e.events.disableBlur(),
                              e.popups.hide(a),
                  ...
                  _editorKeydown: function(e) {
                      var t = s.data("instance") || h;
                      t.keys.ctrlKey(e) || e.which === V.KEYCODE.ALT || e.which === V.KEYCODE.ESC || (m(a) && s.findVisible(".fr-back").length ? t.button.exec(s.findVisible(".fr-back").first()) : e.which !== V.KEYCODE.ALT && t.popups.hide(a))
                  },
                  _preventFocus: function(e) {
                      ...
                      "mouseup" !== e.type || d(n).hasClass("fr-command") || 0 < d(n).parents(".fr-command").length || d(n).hasClass("fr-dropdown-content") || d(n).hasClass("fr-dropdown-menu") || h.button.hideActiveDropdowns(s),
                      (h.browser.safari || h.browser.mozilla) && "mousedown" === e.type && d(n).is("input[type=file]") && t.events.disableBlur();
                  ...
                  _editorMouseup: function() {
                      s.isVisible() && l() && 0 < s.findVisible("input:focus, textarea:focus, button:focus, select:focus").length && h.events.disableBlur()
                  },
                  _windowMouseup: function(e) {
                      if (!h.core.sameInstance(s))
                          return !0;
                      var t = s.data("instance") || h;
                      s.isVisible() && l() && (e.stopPropagation(),
                      t.markers.remove(),
                      t.popups.hide(a),
                      L())
                  },
                  _windowKeydown: function(e) {
                      ...
                      var t = s.data("instance") || h
                        , n = e.which;
                      if (V.KEYCODE.ESC === n) {
                          if (t.popups.isVisible(a) && t.opts.toolbarInline)
                              return e.stopPropagation(),
                              t.popups.isVisible(a) && (s.findVisible(".fr-back").length ? (t.button.exec(s.findVisible(".fr-back").first()),
                              t.accessibility.focusPopupButton(s)) : s.findVisible(".fr-dismiss").length ? t.button.exec(s.findVisible(".fr-dismiss").first()) : (t.popups.hide(a),
                              t.toolbar.showInline(null, !0),
                              t.accessibility.focusPopupButton(s))),
                              !1;
                          if (t.popups.isVisible(a))
                              return s.findVisible(".fr-back").length ? (t.button.exec(s.findVisible(".fr-back").first),
                              t.accessibility.focusPopupButton(s)) : s.findVisible(".fr-dismiss").length ? t.button.exec(s.findVisible(".fr-dismiss").first()) : (t.popups.hide(a),
                              t.accessibility.focusPopupButton(s)),
                              !1
                      }
                  ...
                  _repositionPopup: function() {
                      if (!h.opts.height && !h.opts.heightMax || h.opts.toolbarInline)
                          return !0;
                      if (h.$wp && m(a) && s.parent().get(0) === h.$sc.get(0)) {
                          var e = s.offset().top - h.$wp.offset().top
                            , t = h.$wp.outerHeight();
                          h.node.hasClass(s.get(0), "fr-above") && (e += s.outerHeight()),
                          t < e || e < 0 ? s.addClass("fr-hidden") : s.removeClass("fr-hidden")
                      }
                  },
                  handleWindowClick: function(e) {
                      if (!h.core.sameInstance(s))
                          return !0;
                      var t = s.data("instance") || h;
                      s.isVisible() && e.target && (0 < d(e.target).find("body").length || "BODY" === d(e.target)[0].tagName) && (e.stopPropagation(),
                      t.popups.hide(a))
                  }
              }
          }
          function f(e, t) {
              h.events.on("mouseup", e._editorMouseup, !0),
              h.$wp && h.events.on("keydown", e._editorKeydown),
              h.events.on("focus", function() {
                  g[t].removeClass("focused")
              }),
              h.events.on("blur", function() {
                  v() && h.markers.remove(),
                  h.helpers.isMobile() ? g[t].hasClass("focused") ? (b(),
                  g[t].removeClass("focused")) : g[t].addClass("focused") : g[t].find("iframe").length || b()
              }),
              h.$wp && !h.helpers.isMobile() && h.events.$on(h.$wp, "scroll.popup".concat(t), e._repositionPopup),
              h.events.on("window.mouseup", e._windowMouseup, !0),
              h.events.on("window.keydown", e._windowKeydown, !0),
              h.opts.iframe && window.addEventListener("click", e.handleWindowClick),
              g[t].data("inst".concat(h.id), !0),
              h.events.on("destroy", function() {
                  h.core.sameInstance(g[t]) && (d("body").first().append(g[t]),
                  g[t].removeClass("fr-active"))
              }, !0)
          }
          function p() {
          ...
          return h.shared.exit_flag = !1,
          {
              _init: function y() {
                  ...
                  h.events.on("shared.destroy", e, !0),
                  h.events.on("window.mousedown", t),
                  h.events.on("window.touchmove", L),
                  h.events.$on(d(h.o_win), "scroll", L),
                  h.events.on("mousedown", function(e) {
                      v() && (e.stopPropagation(),
                      h.$el.find(".fr-marker").remove(),
                      t(),
                      h.events.disableBlur())
                  })
              },
              create: function S(e, t) {
                  var n = c(e, t)
                    , r = E(e);
                  f(r, e),
                  h.events.$on(n, "mousedown mouseup touchstart touchend touch", "*", r._preventFocus, !0),
                  h.events.$on(n, "focus", "input, textarea, button, select", r._inputFocus, !0),
                  h.events.$on(n, "blur", "input, textarea, button, select", r._inputBlur, !0);
                  ...
                  h.events.$on(o, "focus", a),
                  h.events.$on(o, "blur change", s),
                  h.events.$on(n, "click", ".fr-checkbox + label", p),
                  h.accessibility.registerPopup(e),
                  h.helpers.isIOS() && h.events.$on(n, "touchend", "label", function() {
                      d("#".concat(d(this).attr("for"))).prop("checked", function(e, t) {
                          return !t
                      })
                  }, !0),
                  h.events.$on(d(h.o_win), "resize", r._windowResize, !0),
                  "filesManager.insert" === e && g["filesManager.insert"].css("zIndex", 2147483641),
                  n
              },
              get: function N(e) {
                  var t = g[e];
                  return t && !t.data("inst".concat(h.id)) && f(E(e), e),
                  t
              },
              show: function T(e, t, n, r, o) {
                  if (m(e) || (v() && 0 < h.$el.find(".fr-marker").length ? (h.events.disableBlur(),
                  h.selection.restore()) : v() || (h.events.disableBlur(),
                  h.events.focus(),
                  h.events.enableBlur())),
                  b([e]),
                  !g[e])
                  ...
                  h.opts.toolbarInline && s && h.$tb && s.get(0) === h.$tb.get(0) && (C(e, h.$sc),
                  n = h.$tb.offset().top - h.helpers.getPX(h.$tb.css("margin-top")),
                  t = h.$tb.offset().left + h.$tb.outerWidth() / 2,
                  h.node.hasClass(h.$tb.get(0), "fr-above") && n && (n += h.$tb.outerHeight()),
                  r = 0),
                  ...
                  h.opts.iframe && !r && !a) {
                      ...
                      t && (t -= h.$iframe.offset().left + c),
                      n && (n -= h.$iframe.offset().top + l)
                  }
                  s.is(h.$tb) ? h.$tb.css("zIndex", (h.opts.zIndex || 1) + 4) : g[e].css("zIndex", (h.opts.zIndex || 1) + 3),
                  h.opts.toolbarBottom && s && h.$tb && s.get(0) === h.$tb.get(0) && (g[e].addClass("fr-above"),
                  n && (n -= g[e].outerHeight())),
                  o && (t -= g[e].width() / 2),
                  t + g[e].outerWidth() > h.$sc.offset().left + h.$sc.width() && (t -= t + g[e].outerWidth() - h.$sc.offset().left - h.$sc.width()),
                  t < h.$sc.offset().left && "rtl" === h.opts.direction && (t = h.$sc.offset().left),
                  g[e].removeClass("fr-active"),
                  h.position.at(t, n, g[e], r || 0);
                  ...
                  a || h.accessibility.focusPopup(g[e]),
                  h.opts.toolbarInline && h.toolbar.hide(),
                  h.$tb && (u = h.$tb.find(".fr-btn-active-popup")),
                  h.events.trigger("popups.show.".concat(e)),
                  E(e)._repositionPopup(),
                  L()
              },
              hide: n,
              onHide: function M(e, t) {
              ...
              refresh: function A(e) {
                  g[e].data("instance", h),
                  h.events.trigger("popups.refresh.".concat(e));
              ...
              setPopupDimensions: function w(e, t) {
                  t && e.find(".fr-upload-progress-layer").get(0).clientHeight < i && (e.find(".fr-upload-progress").addClass("fr-height-auto"),
                  h.popups.get("filesManager.insert").addClass("fr-height-auto"),
                  e.find(".fr-upload-progress").removeClass("fr-height-set"),
                  i = 2e3),
                  e.get(0).clientHeight > window.innerHeight / 2 && (window.innerWidth < 500 ? e.get(0).clientHeight > .6 * r && o(e) : 400 < e.get(0).clientHeight && o(e),
      ...
      V.MODULES.accessibility = function(f) {
          ...
          function c(t) {
              ...
              if (t && t.length && !n) {
                  ...
                  !f.browser.safari || l && null != f.shared.safariSelection || (f.shared.safariSelection = f.selection.get().getRangeAt(0).cloneRange()),
          ...
          function u(e, t) {
              var n = e.find("input, textarea, button, select, span").filter(function() {
                  return p(this).isVisible()
              }).not(":disabled")
                , r = n.first();
              if ((n = r.parents(".fr-color-set").get(0) && r.parents(".fr-popup").get(0) ? n.filter("input") : t ? n.last() : n.first()).length)
                  return a(n);
              if (f.shared.with_kb) {
                  var o = e.findVisible(".fr-active-item").first();
                  if (o.length)
                      return a(o);
                  var i = e.findVisible("[tabIndex]").first();
                  if (i.length)
                      return a(i)
              }
          }
                  ...
                  if (0 === i && !n || i === o.length - 1 && n) {
                      ...
                      if (t) {
                          if (e.parent().is(".fr-popup"))
                              a = !u(e.parent().children().not(".fr-buttons"), !n);
          ...
          function b(e) {
              if (f.shared.$f_el) {
                  ...
                  if (f.shared.$f_el.is(".fr-dropdown.fr-active"))
                      return c(t = e ? f.shared.$f_el.next().find(".fr-command:not(.fr-disabled)").first() : f.shared.$f_el.next().find(".fr-command:not(.fr-disabled)").last()),
                      !1;
          ...
          function E() {
              if (f.shared.$f_el && (f.events.disableBlur(),
              f.shared.$f_el.blur(),
              f.shared.$f_el = null),
              !1 !== f.events.trigger("toolbar.focusEditor") && (f.events.disableBlur(),
              f.$el.get(0).focus(),
              f.events.focus(),
              f.browser.safari && f.shared.safariSelection)) {
                  ...
                  i.setStart(t, r),
                  i.setEnd(n, o),
                  f.selection.get().removeAllRanges(),
                  f.selection.get().addRange(i),
                  f.shared.safariSelection = null
              }
          }
          function o(r) {
          ...
          return {
                      ...
                      return {
                          _tiKeydown: function(e) {
                              ...
                              if (V.KEYCODE.TAB === n) {
                                  ...
                                  if (s.length && h(s, Boolean(e.shiftKey)))
                                      return e.stopPropagation(),
                                      !1;
                                  if (u(o))
                                      return e.stopPropagation(),
                                  ...
                                  if (V.KEYCODE.ENTER !== n || !e.target || "TEXTAREA" === e.target.tagName)
                                      ...
                                      y(d)) : t.popups.isVisible(c) && d.findVisible(".fr-dismiss").length ? t.button.exec(d.findVisible(".fr-dismiss").first()) : (t.popups.hide(c),
              ...
              focusPopup: function T(r) {
                  ...
                  !u(o) && f.shared.with_kb && h(r.find(".fr-buttons"))
              },
              ...
              exec: function O(e, t) {
                  ...
                  return r !== V.KEYCODE.TAB || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.TAB || n || !e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ENTER && r !== V.KEYCODE.SPACE || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.ESC || n || e.shiftKey || e.altKey ? r !== V.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (o = d()) : o = function i(e) {
                      if (f.shared.$f_el) {
                          ...
                          c(t)) : e.parent().findVisible(".fr-back").length ? (f.shared.with_kb = !1,
                          f.opts.toolbarInline && (f.events.disableBlur(),
                          f.events.focus()),
                          f.button.exec(e.parent().findVisible(".fr-back")).first(),
                          y(e.parent())) : f.shared.$f_el.is("button, .fr-group span") && (e.parent().is(".fr-popup") ? (f.accessibility.restoreSelection(),
                          f.shared.$f_el = null,
                      ...
                      return f.shared.$f_el && f.shared.$f_el.is(".fr-dropdown:not(.fr-active)") ? L() : b(!0)
                  }() : o = function s() {
                      return b()
                  }() : o = v(t) : o = v(t, !0) : o = m(t) : (l = r,
                  o = m(t, !0)),
      ...
      V.MODULES.tooltip = function(p) {
          var h = p.$;
          function r() {
              p.helpers.isMobile() || p.$tooltip && p.$tooltip.removeClass("fr-visible").css("left", "-3000px").css("position", "fixed")
          }
          function o(e, t) {
              if (!p.helpers.isMobile()) {
                  var n = e.attr("id") && e.attr("id").split("-")[0]
                    , r = e.attr("title")
                    , o = p.opts.trackChangesEnabled
                    , i = p.opts.showChangesEnabled;
                  if (p.opts.toolbarContainer) {
                      for (var a = !1, s = 0; s < V.INSTANCES.length; s++)
                          if (V.INSTANCES[s].core.hasFocus()) {
                              o = V.INSTANCES[s].opts.trackChangesEnabled,
                              i = V.INSTANCES[s].opts.showChangesEnabled,
                              a = !0;
                              break
                          }
                      a || (i = o = e.hasClass("fr-active"))
                  }
                  if ("trackChanges" === n)
                      r = o ? "Disable Track Changes" : "Enable Track Changes";
                  else if ("showChanges" === n)
                      r = i ? "Hide Changes" : "Show Changes";
                  else if (("applyAll" === n || "removeAll" === n || "applyLast" === n || "removeLast" === n) && 0 === p.track_changes.getPendingChanges().length)
                      return;
                  if (e.data("title", r),
                  e.data("title")) {
                      p.$tooltip || function f() {
                          if (p.opts.tooltips && !p.helpers.isMobile()) {
                              if (p.shared.$tooltip)
                                  p.$tooltip = p.shared.$tooltip;
                              else {
                                  p.shared.$tooltip = h(p.doc.createElement("DIV")).addClass("fr-tooltip"),
                                  p.$tooltip = p.shared.$tooltip,
                                  p.opts.theme && p.$tooltip.addClass("".concat(p.opts.theme, "-theme"));
                                  var e = {};
                                  p.$wp && 0 < p.$wp.length && (e = p.$wp.closest("dialog")),
                                  0 < e.length ? e.first().append(p.$tooltip) : h(p.o_doc).find("body").first().append(p.$tooltip)
                              }
                              p.events.on("shared.destroy", function() {
                                  p.$tooltip.html("").removeData().remove(),
                                  p.$tooltip = null
                              }, !0)
                          }
                      }(),
                      e.removeAttr("title"),
                      p.$tooltip.text(p.language.translate(e.data("title"))),
                      p.$tooltip.addClass("fr-visible");
                      var l = e.offset().left + (e.outerWidth() - p.$tooltip.outerWidth()) / 2;
                      l < 0 && (l = 0),
                      l + p.$tooltip.outerWidth() > h(p.o_win).width() && (l = h(p.o_win).width() - p.$tooltip.outerWidth()),
                      void 0 === t && (t = p.opts.toolbarBottom),
                      e.offset().top - h(window).scrollTop() + e.outerHeight() + 10 >= h(window).height() && (t = !0);
                      var c = t ? e.offset().top - p.$tooltip.height() : e.offset().top + e.outerHeight();
                      p.$tooltip.css("position", ""),
                      p.$tooltip.css("left", l),
                      p.$tooltip.css("top", Math.ceil(c));
                      var d = {};
                      p.$wp && 0 < p.$wp.length && (d = p.$wp.closest("dialog")),
                      0 < d.length ? (p.$tooltip.css("margin-left", -d.first().offset().left),
                      p.$tooltip.css("margin-top", -d.first().offset().top)) : "static" !== h(p.o_doc).find("body").first().css("position") ? (p.$tooltip.css("margin-left", -h(p.o_doc).find("body").first().offset().left),
                      p.$tooltip.css("margin-top", -h(p.o_doc).find("body").first().offset().top)) : (p.$tooltip.css("margin-left", ""),
                      p.$tooltip.css("margin-top", ""))
                  }
              }
          }
          return {
              ...
              bind: function i(e, t, n) {
                  p.opts.tooltips && !p.helpers.isMobile() && (p.events.$on(e, "mouseover", t, function(e) {
                      p.node.hasClass(e.currentTarget, "fr-disabled") || p.edit.isDisabled() || o(h(e.currentTarget), n)
                  }, !0),
                  p.events.$on(e, "mouseout ".concat(p._mousedown, " ").concat(p._mouseup), t, function() {
                      r()
                  }, !0))
              }
          }
      ...
      V.MODULES.button = function(g) {
          ...
          function i(e) {
              ...
              if (!n) {
                  ...
                  if (!g.opts.toolbarBottom && t.offset().top + e.outerHeight() + i < u(g.o_doc).height())
              ...
              function h(e, t, n) {
                  ...
                  e.parent().css("overflow-x", "hidden")),
          ...
          function t(e) {
              var t = e.parents(".fr-popup, .fr-toolbar").data("instance")
                , n = g.popups.get("link.insert");
              if (0 === e.parents(".fr-popup").length && e.data("popup") && !e.hasClass("fr-btn-active-popup") && (e.attr("id") === "insertLink-".concat(g.id) && n && n.hasClass("fr-active") || e.addClass("fr-btn-active-popup")),
              0 !== e.parents(".fr-popup").length || e.data("popup") || t.popups.hideAll(),
              t.popups.areVisible() && !t.popups.areVisible(t)) {
                  for (var r = 0; r < V.INSTANCES.length; r++)
                      V.INSTANCES[r] !== t && V.INSTANCES[r].popups && V.INSTANCES[r].popups.areVisible() && V.INSTANCES[r].$el.find(".fr-marker").remove();
                  t.popups.hideAll()
              }
              g.node.hasClass(e.get(0), "fr-dropdown") ? i(e) : (!function o(e) {
                  c(e)
              }(e),
          ...
          return {
              _init: function b() {
                  g.opts.toolbarInline ? g.events.on("toolbar.show", n) : (g.events.on("mouseup", v),
                  g.events.on("keyup", v),
                  g.events.on("blur", v),
                  g.events.on("focus", v),
                  ...
                  for (var r in e) {
                      ...
                      if (o.buttons) {
                          for (var i = "", a = "", s = 0, l = "left", c = V.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < o.buttons.length; d++) {
                              ...
                              e.showMoreButtons && c <= s ? a += m(f, p, !0) : i += m(f, p, !0),
                              s++)
                          }
                          ...
                          "trackChanges" !== r && (t += '<div class="fr-btn-grp fr-float-'.concat(l, '">').concat(i, "</div>")),
                          e.showMoreButtons && 0 < a.length && (n += '<div class="fr-more-toolbar" data-name="'.concat(r + "-" + g.id, '">').concat(a, "</div>"))
                      }
                  }
                  return g.opts.toolbarBottom ? g.helpers.isMobile() ? '<div class="fr-bottom-extended">'.concat(n, "</div><div>").concat(t, "</div>") : "".concat(n, '<div class="fr-newline"></div>').concat(t) : "".concat(t, '<div class="fr-newline"></div>').concat(n)
              },
              bindCommands: function y(t, e) {
                  g.events.bindClick(t, ".fr-command:not(.fr-disabled)", d),
                  g.events.$on(t, "".concat(g._mousedown, " ").concat(g._mouseup, " ").concat(g._move), ".fr-dropdown-menu", p, !0),
                  g.events.$on(t, "".concat(g._mousedown, " ").concat(g._mouseup, " ").concat(g._move), ".fr-dropdown-menu .fr-dropdown-wrapper", h, !0);
                  var n = t.get(0).ownerDocument
                    , r = "defaultView"in n ? n.defaultView : n.parentWindow;
                  function o(e) {
                      (!e || e.type === g._mouseup && e.target !== u("html").get(0) || "keydown" === e.type && (g.keys.isCharacter(e.which) && !g.keys.ctrlKey(e) || e.which === V.KEYCODE.ESC)) && (f(t),
                      g.opts.iframe && function r(e) {
                          var t = e.find(".fr-popup.fr-active");
                          if (t.length) {
                              t.removeClass("fr-active").attr("aria-expanded", !1).next().attr("aria-hidden", !0).css("overflow", "").find("> .fr-dropdown-wrapper").css("height", ""),
                              t.parents(".fr-toolbar:not(.fr-inline)").css("zIndex", ""),
                              t.prev().removeClass("fr-expanded");
                              var n = g.$tb.find(".fr-btn-active-popup");
                              u(n[0]).removeClass("fr-btn-active-popup")
                          }
                      }(t))
                  }
                  g.events.$on(u(r), "".concat(g._mouseup, " resize keydown"), o, !0),
                  g.opts.iframe && g.events.$on(g.$win, g._mouseup, o, !0),
                  g.node.hasClass(t.get(0), "fr-popup") ? u.merge(s, t.find(".fr-btn").toArray()) : u.merge(a, t.find(".fr-btn").toArray()),
      ...
      V.MODULES.modals = function(l) {
          ...
          function s(e, t) {
              if (c[e]) {
                  ...
                  n.hide(),
                  o.hide(),
                  a(r.o_doc).find("body").first().removeClass("fr-prevent-scroll fr-mobile"),
      ...
      V.MODULES.position = function(L) {
          ...
          function o() {
              ...
              if (0 === t.top && 0 === t.left && 0 === t.width || 0 === t.height) {
                  var n = !1
                    , r = L.opts.toolbarInline && e.startContainer && e.startContainer.firstChild && "BR" === e.startContainer.firstChild.tagName;
                  0 === L.$el.find(".fr-marker").length && (r ? E(e.startContainer.firstChild).after(V.MARKERS) : L.selection.save(),
                  n = !0);
                  var o = L.$el.find(".fr-marker").first();
                  ...
                  t.width = 0,
                  t.height = a,
                  t.top = i && i.top - (L.helpers.isMobile() && !L.helpers.isIOS() || L.opts.iframe ? 0 : L.helpers.scrollTop()),
                  o && 0 < o.length && (t.top -= E(o.get(0).parentNode).height()),
                  t.right = 1,
                  t.bottom = 1,
                  t.ok = !0,
                  n && (r ? L.$el.find(".fr-marker").remove() : L.selection.restore())
              }
              return t
          }
          function i(e, t, n, r) {
              ...
              var s = function l(e, t) {
                  ...
                  return t + n > L.$sc.get(0).clientWidth - 10 && (t = L.$sc.get(0).clientWidth - n - 10),
                  t < 0 && (t = 10),
                  t
              }(n, e);
              e && n.css("left", s),
              t && n.css("top", function c(e, t, n) {
                  ...
                  if (!L.helpers.isMobile() && L.$tb && e.parent().get(0) !== L.$tb.get(0)) {
                      ...
                      o + t + r > L.$sc.offset().top + a && 0 < e.parent().offset().top + i && 0 < i ? i > L.$wp.scrollTop() && (t = i,
          ...
          function a(e) {
              ...
              if (void 0 === r) {
                  ...
                  L.$box.find(".fr-sticky-dummy").css("height", n.outerHeight());
              if (L.core.hasFocus() || 0 < L.$tb.findVisible("input:focus").length) {
                  ...
                  n.outerHeight() < a - L.$tb.parent().offset().top && n.addClass("fr-opacity-0"),
                  n.data("sticky-timeout", setTimeout(function() {
                      ...
                      0 < t && "BODY" === L.$tb.parent().get(0).tagName && (t += L.$tb.parent().position().top),
          ...
          function t(e) {
              if (e.offsetWidth) {
                  var t = E(e)
                    ...
                    , i = 0
                    , a = 0;
                  "body" !== L.opts.scrollableContainer && (i = L.$sc.offset().top,
                  a = E(L.o_win).outerHeight() - i - o);
                  ...
                  var c = t.data("sticky-parent")
                    , d = c.offset().top
                    , f = c.outerHeight();
                  if (t.data("sticky-offset") ? L.$box.find(".fr-sticky-dummy").css("height", "".concat(n, "px")) : (t.data("sticky-offset", !0),
                  ...
                  !r) {
                      ...
                      t.data("top", L.node.hasClass(t.get(0), "fr-top") ? t.css("top") : "auto"),
                      t.data("bottom", L.node.hasClass(t.get(0), "fr-bottom") ? t.css("bottom") : "auto")
                  }
                  ...
                  if (g || C) {
                      ...
                      t.css("width", "".concat(c.get(0).getBoundingClientRect().width - m, "px")),
                      l || (t.addClass("fr-sticky-on"),
                      t.removeClass("fr-sticky-off"),
                      t.css("top") && ("auto" !== t.data("top") ? t.css("top", L.helpers.getPX(t.data("top")) + i) : t.data("top", "auto")),
                      t.css("bottom") && ("auto" !== t.data("bottom") ? t.css("bottom", L.helpers.getPX(t.data("bottom")) + a) : t.css("bottom", "auto")))
                  } else
                      L.node.hasClass(t.get(0), "fr-sticky-off") || (t.css("width", ""),
          ...
          function s() {
              if (L.helpers.requestAnimationFrame()(s),
          ...
          return {
              _init: function e() {
                  !function t() {
                      if (L._stickyElements = [],
                      L.helpers.getIOSVersion() <= 8)
                          s(),
                          L.events.$on(E(L.o_win), "scroll", function() {
                              if (L.core.hasFocus())
                                  for (var e = 0; e < L._stickyElements.length; e++) {
                                      var t = E(L._stickyElements[e])
                                        , n = t.parent()
                                        , r = L.helpers.scrollTop();
                                      t.outerHeight() < r - n.offset().top && (L.opts.toolbarBottom && L.helpers.isIOS() || (t.addClass("fr-opacity-0"),
                                      t.data("sticky-top", -1),
                                      t.data("sticky-scheduled", -1)))
                                  }
                          }, !0);
                      else {
                          "body" !== L.opts.scrollableContainer && L.events.$on(E(L.opts.scrollableContainer), "scroll", n, !0),
                          L.events.$on(E(L.o_win), "scroll", n, !0),
                          L.events.$on(E(L.o_win), "resize", n, !0),
                          L.events.on("initialized", n),
                          L.events.on("focus", n),
                          L.events.$on(E(L.o_win), "resize", "textarea", n, !0);
                          var e = E(L.el).parents(".modal");
                          e.get(0) && L.events.$on(e, "scroll", n, !0)
                      }
              ...
              forSelection: function l(e) {
                  ...
                  if (t.top != undefined) {
                      ...
                      L.opts.iframe || (n += L.helpers.scrollTop()),
                      i(r, n, e, t.height)
                  }
              },
              addSticky: function r(e) {
                  e.addClass("fr-sticky"),
                  L.helpers.isIOS() && !L.opts.toolbarBottom && e.addClass("fr-sticky-ios"),
          ...
          return {
              ...
              outdent: function a(e) {
                  if (l.node.hasClass(e.get(0), "fr-no-refresh"))
                      return !1;
                  if (c("button#markdown-".concat(l.id, ".fr-active")).length)
                      return !1;
                  for (var t = l.selection.blocks(), n = 0; n < t.length; n++) {
                      var r = "rtl" === l.opts.direction || "rtl" === c(t[n]).css("direction") ? "margin-right" : "margin-left"
                        , o = t[0].parentElement;
                      if (["HTML", "P", "DIV", "UL", "OL", "LI", "TR", "BLOCKQUOTE", "BODY"].indexOf(o.parentNode.tagName) < 0)
                          return i(e, !0),
                          !0;
      ...
      V.MODULES.toolbar = function(E) {
          ...
          function e(e) {
              ...
              if (Array.isArray(e)) {
                  ...
                  "object" !== A(e) || Array.isArray(e) || ((n = e).showMoreButtons = !0);
              return n
          }
          function N() {
              var e = E.helpers.screenSize(E.opts.toolbarResponsiveToEditor);
              return t[y = e]
          }
          function T() {
              for (var d = E.$tb.find(".fr-more-toolbar"), f = function f() {
                  var e = S(d[p]);
                  if (e.hasClass("fr-expanded")) {
                      var n = E.helpers.getPX(e.css("padding-left"))
                        , t = e.find("> .fr-command, > .fr-btn-wrap")
                        , r = S(t[0])
                        , o = E.helpers.getPX(r.css("margin-left"))
                        , i = E.helpers.getPX(r.css("margin-right"))
                        , a = E.helpers.getPX(r.css("margin-top"))
                        , s = E.helpers.getPX(r.css("margin-bottom"));
                      if (t.each(function(e, t) {
                          n += S(t).outerWidth() + o + i
                      }),
                      E.$tb.outerWidth() < n) {
                          var l = Math.floor(n / E.$tb.outerWidth());
                          n += l * (n / e[0].childElementCount),
                          l = Math.ceil(n / E.$tb.outerWidth());
                          var c = (E.helpers.getPX(r.css("height")) + a + s) * l;
                          e.css("height", c)
                      }
                  } else
                      e.css("height", "")
          ...
          function o() {
              if (0 == E.$tb.find("[data-name='trackChanges-".concat(E.id, "']")).length && -1 < E.opts.pluginsEnabled.indexOf("track_changes")) {
                  ...
                  for (var e = 0, t = ["showChanges", "applyAll", "removeAll", "applyLast", "removeLast"]; e < t.length; e++) {
                      ...
                      if (r) {
                          ...
                          E.button.addButtons(o),
                          E.$tb.find("[data-name='trackChanges-".concat(E.id, "']")).append(o)
                      }
                  }
              }
              if (y !== E.helpers.screenSize(E.opts.toolbarResponsiveToEditor)) {
                  ...
                  function L() {
                      for (var e = E.$tb.find(".fr-btn-grp, .fr-more-toolbar"), t = function t() {
                          var n = S(e[r]);
                  ...
                  i) {
                      var c = i[l];
                      if (c.buttons && ("trackChanges" !== l || -1 !== E.opts.pluginsEnabled.indexOf("track_changes"))) {
                          var d = void 0
                            , f = 0
                            , p = 3
                            , h = void 0;
                          "trackChanges" !== l && (h = S('<div class="fr-btn-grp fr-float-'.concat(i[l].align ? i[l].align : "left", '"></div>'))),
                          i.showMoreButtons && (d = S('<div class="fr-more-toolbar"></div>').data("name", "".concat(l, "-").concat(E.id)),
                          "trackChanges" !== l && "moreRich" !== l || !E.opts.trackChangesEnabled || d.addClass("fr-expanded"));
                          for (var u = 0; u < c.buttons.length; u++) {
                              c.buttonsVisible !== undefined && (p = c.buttonsVisible);
                              var g = E.$tb.find('> .fr-command[data-cmd="' + c.buttons[u] + '"], > div.fr-btn-wrap > .fr-command[data-cmd="' + c.buttons[u] + '"]')
                                , C = null;
                              E.node.hasClass(g.next().get(0), "fr-dropdown-menu") && (C = g.next()),
                              E.node.hasClass(g.next().get(0), "fr-options") && (g.removeClass("fr-hidden"),
                              g.next().removeClass("fr-hidden"),
                              g = g.parent()),
                              g.removeClass("fr-hidden"),
                              i.showMoreButtons && p <= f ? (d.append(g),
                              C && d.append(C)) : (h.append(g),
                              C && h.append(C)),
                              f++
                          }
                          if (i.showMoreButtons && p < f) {
                              ...
                              if (0 < m.length)
                                  m.removeClass("fr-hidden fr-open");
                              else {
                                  var v = l
                                    , b = V.COMMANDS[v];
                                  b && (b.more_btn = !0,
                                  m = S(E.button.build(v, b, !0)),
                                  E.button.addButtons(m))
                              }
                              h && h.append(m)
                          }
                          h && a.push(h),
                          i.showMoreButtons && s.push(d)
                      }
                  }
                  E.opts.toolbarBottom ? (E.$tb.append(s),
                  E.$tb.find(".fr-newline").remove(),
                  E.$tb.append('<div class="fr-newline"></div>'),
                  E.$tb.append(a)) : (E.$tb.append(a),
                  E.$tb.find(".fr-newline").remove(),
                  E.$tb.append('<div class="fr-newline"></div>'),
                  E.$tb.append(s)),
                  E.$tb.removeClass("fr-toolbar-open"),
                  E.$box.removeClass("fr-toolbar-open"),
                  E.events.trigger("codeView.toggle")
              }
              T()
          }
          function n(t, n) {
              setTimeout(function() {
                  var e;
                  E.opts.iframe ? e = E.$iframe.get(0).contentWindow.document.activeElement : e = document.activeElement;
                  if ((!t || t.which != V.KEYCODE.ESC) && E.selection.inEditor() && E.core.hasFocus() && !E.popups.areVisible() && "false" != S(E.selection.blocks()[0]).closest("table").attr("contenteditable") && "INPUT" !== e.tagName && "TEXTAREA" !== e.tagName && (E.opts.toolbarVisibleWithoutSelection || !E.selection.isCollapsed() && !E.keys.isIME() || n)) {
                      if (E.$tb.data("instance", E),
                      !1 === E.events.trigger("toolbar.show", [t]))
                          return;
                      E.$tb.show(),
                      E.opts.toolbarContainer || E.position.forSelection(E.$tb),
                      1 < E.opts.zIndex ? E.$tb.css("z-index", E.opts.zIndex + 1) : E.$tb.css("z-index", null)
                  }
              }, 0)
          }
          function i(e) {
              return (!e || "blur" !== e.type || document.activeElement !== E.el) && (!(!e || "keydown" !== e.type || !E.keys.ctrlKey(e)) || (!!E.button.getButtons(".fr-dropdown.fr-active").next().find(E.o_doc.activeElement).length || (E.helpers.isMobile() && E.opts.toolbarInline && (E.$tb.find(".fr-expanded").toggleClass("fr-expanded"),
              E.$tb.find(".fr-open").removeClass("fr-open"),
              E.$tb.removeClass("fr-toolbar-open"),
              T()),
              void (!1 !== E.events.trigger("toolbar.hide") && E.$tb.hide()))))
          }
          t[V.XS] = e(E.opts.toolbarButtonsXS || E.opts.toolbarButtons || V.TOOLBAR_BUTTONS_XS || V.TOOLBAR_BUTTONS || []),
          t[V.SM] = e(E.opts.toolbarButtonsSM || E.opts.toolbarButtons || V.TOOLBAR_BUTTONS_SM || V.TOOLBAR_BUTTONS || []),
          t[V.MD] = e(E.opts.toolbarButtonsMD || E.opts.toolbarButtons || V.TOOLBAR_BUTTONS_MD || V.TOOLBAR_BUTTONS || []),
          t[V.LG] = e(E.opts.toolbarButtons || V.TOOLBAR_BUTTONS || []);
          var r = null;
          function a(e) {
              clearTimeout(r),
              e && e.which === V.KEYCODE.ESC || (r = setTimeout(n, E.opts.typingTimer))
          }
          function s() {
              E.events.on("window.mousedown", i),
              E.events.on("keydown", i),
              E.events.on("blur", i),
              E.events.$on(E.$tb, "transitionend", ".fr-more-toolbar", function() {
                  E.position.forSelection(E.$tb)
              }),
              E.helpers.isMobile() || E.events.on("window.mouseup", n),
              E.helpers.isMobile() ? E.helpers.isIOS() || (E.events.on("window.touchend", n),
              E.browser.mozilla && setInterval(n, 200)) : E.events.on("window.keyup", a),
              ...
              E.events.$on(E.$wp, "scroll.toolbar", n),
              E.events.on("commands.after", n),
              E.helpers.isMobile() && (E.events.$on(E.$doc, "selectionchange", a),
              E.events.$on(E.$doc, "orientationchange", n))
          }
          function l() {
              E.$tb.html("").removeData().remove(),
              E.$tb = null,
              E.$second_tb && (E.$second_tb.html("").removeData().remove(),
              E.$second_tb = null)
          }
          function c() {
              E.$box.removeClass("fr-top fr-bottom fr-inline fr-basic"),
              E.$box.find(".fr-sticky-dummy").remove()
          }
          function d() {
              E.opts.theme && E.$tb.addClass("".concat(E.opts.theme, "-theme")),
              1 < E.opts.zIndex && E.$tb.css("z-index", E.opts.zIndex + 1),
              "auto" !== E.opts.direction && E.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(E.opts.direction)),
              E.helpers.isMobile() ? E.$tb.addClass("fr-mobile") : E.$tb.addClass("fr-desktop"),
              E.opts.toolbarContainer ? (E.opts.toolbarInline && (s(),
              i()),
              E.opts.toolbarBottom ? E.$tb.addClass("fr-bottom") : E.$tb.addClass("fr-top")) : function e() {
                  E.opts.toolbarInline ? (E.$sc.append(E.$tb),
                  E.$tb.data("container", E.$sc),
                  E.$tb.addClass("fr-inline"),
                  s(),
                  E.opts.toolbarBottom = !1) : (E.opts.toolbarBottom ? (E.$box.append(E.$tb),
                  E.$tb.addClass("fr-bottom"),
                  E.$box.addClass("fr-bottom")) : (E.opts.toolbarBottom = !1,
                  E.$box.prepend(E.$tb),
                  E.$tb.addClass("fr-top"),
                  E.$box.addClass("fr-top")),
                  E.$tb.addClass("fr-basic"),
                  E.opts.toolbarSticky && (E.opts.toolbarStickyOffset && (E.opts.toolbarBottom ? E.$tb.css("bottom", E.opts.toolbarStickyOffset) : E.$tb.css("top", E.opts.toolbarStickyOffset)),
                  E.position.addSticky(E.$tb)))
              }(),
              function t() {
                  var e = E.button.buildGroup(N());
                  E.$tb.append(e),
                  T(),
                  E.button.bindCommands(E.$tb)
              }(),
              function r() {
                  E.events.$on(S(E.o_win), "resize", o),
                  E.events.$on(S(E.o_win), "orientationchange", o),
                  E.opts.toolbarButtons && -1 < JSON.stringify(E.opts.toolbarButtons).indexOf("trackChanges") && o();
                  var e = E.$tb.find(".fr-more-toolbar[data-name=trackChanges-".concat(E.id, "]"))
                    , t = 0 !== e.length && e.hasClass("fr-expanded");
                  if (E.opts.trackChangesEnabled && !t) {
                      var n = E.$tb.find(".fr-command.fr-btn[data-cmd=trackChanges");
                      e.addClass("fr-expanded"),
                      n.toggleClass("fr-open"),
                      E.toolbar.enable()
                  }
              }(),
              E.accessibility.registerToolbar(E.$tb),
              E.events.$on(E.$tb, "".concat(E._mousedown, " ").concat(E._mouseup), function(e) {
                  var t = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null;
                  if (t && "INPUT" !== t.tagName && !E.edit.isDisabled())
                      return e.stopPropagation(),
                      e.preventDefault(),
                      !1
              }, !0),
              E.helpers.isMobile() && E.events.$on(E.$tb, "click", function() {
                  E.popups.areVisible().length || E.id !== E.shared.selected_editor && E.shared.selected_editor || E.$el.focus()
              }),
              E.events.$on(E.$tb, "transitionend", ".fr-more-toolbar", function() {
                  E.$box.hasClass("fr-fullscreen") && (E.opts.height = E.o_win.innerHeight - (E.opts.toolbarInline ? 0 : E.$tb.outerHeight() + (E.$second_tb ? E.$second_tb.outerHeight() : 0)),
                  E.size.refresh())
              })
          }
          var f = !1;
          return {
              _init: function p() {
                  if (E.$sc = S(E.opts.scrollableContainer).first(),
                  !E.$wp)
                      return !1;
                  E.opts.toolbarInline || E.opts.toolbarBottom || (E.$second_tb = S(E.doc.createElement("div")).attr("class", "fr-second-toolbar"),
                  E.$box.append(E.$second_tb),
                  (!1 !== E.ul || E.opts.attribution) && E.$second_tb.prepend(V.POWERED_BY)),
                  E.opts.toolbarContainer ? (E.shared.$tb ? (E.$tb = E.shared.$tb,
                  E.opts.toolbarInline && s()) : (E.shared.$tb = S(E.doc.createElement("DIV")),
                  E.shared.$tb.addClass("fr-toolbar"),
                  E.$tb = E.shared.$tb,
                  S(E.opts.toolbarContainer).append(E.$tb),
                  d(),
                  E.$tb.data("instance", E)),
                  E.opts.toolbarInline ? E.$box.addClass("fr-inline") : E.$box.addClass("fr-basic"),
                  E.events.on("focus", function() {
                      E.$tb.data("instance", E)
                  }, !0),
                  E.opts.toolbarInline = !1) : E.opts.toolbarInline ? (E.$box.addClass("fr-inline"),
                  E.shared.$tb ? (E.$tb = E.shared.$tb,
                  s()) : (E.shared.$tb = S(E.doc.createElement("DIV")),
                  E.shared.$tb.addClass("fr-toolbar"),
                  E.$tb = E.shared.$tb,
                  d())) : (E.$box.addClass("fr-basic"),
                  E.$tb = S(E.doc.createElement("DIV")),
                  E.$tb.addClass("fr-toolbar"),
                  d(),
                  E.$tb.data("instance", E)),
                  E.events.on("destroy", c, !0),
                  E.events.on(E.opts.toolbarInline || E.opts.toolbarContainer ? "shared.destroy" : "destroy", l, !0),
                  E.events.on("edit.on", function() {
                  ...
                  function e() {
                      E.events.on("shortcut", function(e, t, n) {
                          var r;
                          if (t && !n ? r = E.$tb.find('.fr-command[data-cmd="'.concat(t, '"]')) : t && n && (r = E.$tb.find('.fr-command[data-cmd="'.concat(t, '"][data-param1="').concat(n, '"]'))),
                          r.length && (e.preventDefault(),
                          e.stopPropagation(),
                          r.parents(".fr-toolbar").data("instance", E),
                          "keydown" === e.type))
                              return E.button.exec(r),
                              !1
                      })
                  }()
              },
              hide: i,
              show: function h() {
                  if (!1 === E.events.trigger("toolbar.show"))
                      return !1;
                  E.$tb.show()
              },
              showInline: n,
              disable: function u() {
                  !f && E.$tb && (E.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command, .fr-btn-wrap > .fr-command").addClass("fr-disabled fr-no-refresh").attr("aria-disabled", !0),
                  f = !0)
              },
              enable: function g() {
                  f && E.$tb && (E.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command, .fr-btn-wrap > .fr-command").removeClass("fr-disabled fr-no-refresh").attr("aria-disabled", !1),
                  f = !1),
      ...
      var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"]
        ...
        , h = function h(n, r) {
          return function(e) {
              ...
              if (r)
                  for (r = g(r); t && t !== this; )
                      Element.prototype.matches.call(t, g(r)) && n.call(t, l(e, t)),
                      t = t.parentNode;
              else
                  p(t) && n.call(t, l(e, t))
          }
      ...
      u.fn = u.prototype = {
          ...
          wrapAll: function(e) {
              var t;
              return this[0] && (C(e) && (e = e.call(this[0])),
              t = u(e, this[0].ownerDocument).eq(0).clone(!0),
          ...
          wrapInner: function(e) {
              if ("string" == typeof e) {
                  for (var t = e.split(" "), n = 0; n < t.length && 0 === t[n].trim().length; )
                      n++;
                  if (n < t.length && (m(e).length && t[n].trim() === m(e)[0].tagName && (e = document.createElement(t[n].trim())),
                  n++),
                  "string" != typeof e)
          ...
          wrapContent: function(e) {
              for (var t = document.createElement(e.tagName), n = 0; n < e.attributes.length; n++)
                  m(t).attr(e.attributes[n].nodeName, e.attributes[n].value);
          ...
          css: function(e, t) {
              if (void 0 !== t) {
                  ...
                  for (var n = 0; n < this.length; n++)
                      e = m(this).getCorrectStyleName(e),
                      this[n].style[e] = t;
                  return this
              }
              if ("string" == typeof e) {
                  ...
                  return e = m(this).getCorrectStyleName(e),
          ...
          find: function(e) {
              ...
              var o = function o(e) {
                  return "object" === ("undefined" == typeof HTMLElement ? "undefined" : A(HTMLElement)) ? e instanceof HTMLElement : e && "object" === A(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName
              };
              e = g(e);
              for (var i = 0; i < this.length; i++)
                  ...
                  for (var t = 0; t < this.length; t++) {
                      ...
                      for (var n = this[t].children, r = this[t].ownerDocument || document, o = 0; o < n.length; o++)
                          if ("SCRIPT" === n[o].tagName) {
                              ...
                              n[o].hasAttribute("async") && i.setAttribute("async", ""),
                              i.src = n[o].src,
                              n[o].hasAttribute("defer") && i.setAttribute("defer", ""),
        ...
        prepend: function (e) {
          ...
          outerHeight: function(e) {
              ...
              if (e && (i += parseInt(m(t).css("marginTop")) + parseInt(m(t).css("marginBottom"))),
              !r)
                  for (var a in s)
                      t.style[a] = n[a];
              return i
          ...
          outerWidth: function(e) {
              ...
              if (!r)
                  for (var o in s)
                      ...
                      t.style[o] = s[o];
              var i = t.offsetWidth;
              if (e && (i += parseInt(m(t).css("marginLeft")) + parseInt(m(t).css("marginRight"))),
              !r)
                  for (var a in s)
                      t.style[a] = n[a];
              return i
          ...
          parents: function(e) {
              for (var t = m(), n = 0; n < this.length; n++)
                  for (var r = this[n].parentNode; r && r != document && this._matches(r); )
                      e ? this._matches(r, e) && t.push(r) : t.push(r),
                      r = r.parentNode;
              return t
          },
          parentsUntil: function(e, t) {
              ...
              for (var r = 0; r < this.length; r++)
                  for (var o = this[r].parentNode; o && o != document && o != e && this[r] != e && ("string" != typeof e || !Element.prototype.matches.call(o, e)); )
                      t ? Element.prototype.matches.call(o, t) && n.push(o) : n.push(o),
                      o = o.parentNode;
              return n
          },
      ...
      var v = function v(e, t) {
          ...
          if ("string" == typeof e && "<" === e[0]) {
              ...
              m(n.firstElementChild)
          }
          if (t = t instanceof u ? t[0] : t,
          "string" != typeof e)
              return e instanceof u ? e : (this[0] = e,
              this.length = 1,
              this);
          e = g(e);
      ...
      function L() {
          ...
          this.$doc = u(this.doc),
          this.$win = u(this.win),
          this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(b.PLUGINS)),
          this.opts.initOnClick ? (this.load(b.MODULES),
          ...
          this.$el.on("mousedown.init touchend.init dragenter.init focus.init", function r(e) {
              if ("false" !== this.$el.attr("contentEditable") || !this.opts.initOnClick) {
                  ...
                  if (1 === e.which || !e.which) {
                      ...
                      if (t && "IMG" === t.tagName && u(t).trigger("mousedown"),
                      "undefined" == typeof this.ul && this.destroy(),
                      "touchend" === e.type && this.image && e.originalEvent && e.originalEvent.target && u(e.originalEvent.target).is("img")) {
                          var n = this;
                          setTimeout(function() {
          ...
          .bind(this)),
          this.events.trigger("initializationDelayed")) : (this.load(b.MODULES),
          this.load(b.PLUGINS),
          u(this.o_win).scrollTop(this.c_scroll),
          "undefined" == typeof this.ul && this.destroy(),
          this.ready = !0,
          this.events.trigger("initialized"))
      }
      return b.Bootstrap = function(e, t, n) {
          ...
          this.opts = Object.assign({}, Object.assign({}, b.DEFAULTS, r, "object" === A(t) && t));
          ...
          this.c_scroll = u(this.o_win).scrollTop(),
          this._init()
      }
      ,
      b.Bootstrap.prototype._init = function() {
          ...
          var t = function() {
              ...
              this.opts.iframe ? (this.$iframe = u('<iframe src="about:blank" frameBorder="0">'),
              this.$wp = u("<div></div>"),
              ...
              this.$el = u(this.iframe_document.querySelector("body")),
              this.el = this.$el.get(0),
              this.$head = u(this.iframe_document.querySelector("head")),
              this.$html = u(this.iframe_document.querySelector("html"))) : (this.$el = u(this.o_doc.createElement("DIV")),
              this.el = this.$el.get(0),
              this.$wp = u(this.o_doc.createElement("DIV")).append(this.$el),
              this.$box.html(this.$wp)),
      ...
      b.Bootstrap.prototype.destroy = function() {
          // return; // ! hack // it is destroyed after 10 modifications
          this.destrying = !0,
          this.shared.count--,
