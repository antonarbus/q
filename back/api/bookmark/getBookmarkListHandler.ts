import { type SelectBookmark, bookmarksTable } from '@back/entity/bookmark/db/bookmarksTableSchema'
...
export const getBookmarkListHandler: RouterHandler = async (req) => {
