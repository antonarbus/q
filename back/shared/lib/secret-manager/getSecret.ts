...
export type SecretName =
  ...
  | 'STRIPE_WEBHOOK_SECRET_PILOT'
  | 'STRIPE_WEBHOOK_SECRET_LIVE'
  | 'STRIPE_WEBHOOK_ACCOUNT_SECRET_DEV'
  | 'STRIPE_WEBHOOK_ACCOUNT_SECRET_TEST'
  | 'STRIPE_WEBHOOK_ACCOUNT_SECRET_PILOT'
  | 'STRIPE_WEBHOOK_ACCOUNT_SECRET_LIVE'
...
const cachedSecrets: Record<SecretName, string | null> = {
  ...
  STRIPE_WEBHOOK_SECRET_DEV: null,
  STRIPE_WEBHOOK_SECRET_TEST: null,
  STRIPE_WEBHOOK_SECRET_PILOT: null,
  STRIPE_WEBHOOK_SECRET_LIVE: null,
  STRIPE_WEBHOOK_ACCOUNT_SECRET_DEV: null,
  STRIPE_WEBHOOK_ACCOUNT_SECRET_TEST: null,
  STRIPE_WEBHOOK_ACCOUNT_SECRET_PILOT: null,
  STRIPE_WEBHOOK_ACCOUNT_SECRET_LIVE: null,
