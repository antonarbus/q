...
export type SecretName =
  ...
  | 'STRIPE_DEV_WEBHOOK_ACCOUNT_SECRET'
  | 'STRIPE_TEST_WEBHOOK_ACCOUNT_SECRET'
  | 'STRIPE_PILOT_WEBHOOK_ACCOUNT_SECRET'
  | 'STRIPE_LIVE_WEBHOOK_ACCOUNT_SECRET'
...
const cachedSecrets: Record<SecretName, string | null> = {
  ...
  STRIPE_DEV_WEBHOOK_ACCOUNT_SECRET: null,
  STRIPE_TEST_WEBHOOK_ACCOUNT_SECRET: null,
  STRIPE_PILOT_WEBHOOK_ACCOUNT_SECRET: null,
  STRIPE_LIVE_WEBHOOK_ACCOUNT_SECRET: null,
  STRIPE_TEST_CLIENT_ID: null,
  STRIPE_LIVE_CLIENT_ID: null,
  STRIPE_TEST_SUBSCRIPTION_PRICE_ID_MONTHLY: null,
  STRIPE_TEST_SUBSCRIPTION_PRICE_ID_ANNUAL: null,
  STRIPE_LIVE_SUBSCRIPTION_PRICE_ID_MONTHLY: null,
  STRIPE_LIVE_SUBSCRIPTION_PRICE_ID_ANNUAL: null,
  GEMINI_API_KEY: null,
}
