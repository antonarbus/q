...
export const getDecimalPrecision = ({ valueDifference }: Props): number => {
  ...
  if (absValDifference >= 100) {
    return 0
  }

  if (absValDifference >= 10) {
    return 1
  }

  if (absValDifference >= 1) {
    return 2
  }

  if (absValDifference >= 0.1) {
    return 3
  }

  if (absValDifference >= 0.01) {
    return 4
  }

  if (absValDifference >= 0.001) {
    return 5
  }

  if (absValDifference >= 0.0001) {
    return 6
  }

  if (absValDifference >= 0.00001) {
    return 7
  }

  if (absValDifference >= 0.000001) {
    return 8
  }

  if (absValDifference >= 0.0000001) {
    return 9
  }
