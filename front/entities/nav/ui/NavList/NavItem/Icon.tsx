...
export const Icon = (props: Props): React.JSX.Element => {
  return (
    <Tooltip enterDelay={500} enterNextDelay={500} placement='bottom' title={props.tooltipText}>
      <span className='element-that-keep-ref-from-mui'>
        <RoundSpanForIcon className='icon-round-wrapper' disabled={props.disabled}>
