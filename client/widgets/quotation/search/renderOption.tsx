...
export const renderOption = ({ loadBookmark, inputValueSignal, isPendingBookmark, pendingBookmarkId }: Props) => (props: HTMLAttributes<HTMLLIElement>, option: Item, { selected, index, inputValue }: {
  selected: boolean
  index: number
  inputValue: string
}): JSX.Element => {
