import type { ResBody, ReqBody as Payload } from '@server/api/bookmark/saveBookmarkRouter'
...
export const useSaveBookmarkMutation = (): UseMutationResult<ResBody, AxiosError<ResBody>, Payload> => {
