...
export const defaultItems: Item[] = [
  ...
  },
  {
    ...
    text: {
      html: `
<p style="font-size: 25px; margin-top: 20px; margin-bottom: 10px; text-align: center;" id="isPasted"><span style="font-size: 24px;">Products info</span></p>
<br>
<p style="text-align: center;"><span style="color: grey; ">1.&nbsp;</span><span style="color: grey; " id="isPasted">Add</span><span>&nbsp;description of your products.</span></p>
<br>
<p style="text-align: center;"><span style="color: rgb(0, 0, 0); ">Select text to&nbsp;</span><span style="color: rgb(226, 80, 65); ">format</span><span style="color: rgb(0, 0, 0); ">&nbsp;</span><span style="font-weight: 400; color: rgb(0, 0, 0); "><span style="color: rgb(0, 0, 0); " id="isPasted">it.</span></span></p>
<br>
<p style="text-align: center;"><span style="color: grey; ">2. Insert</span><span>&nbsp;</span><span style="font-weight: 400; ">tables</span></p>
<p style="text-align: center;"><span><br></span></p>
<table style="width: 100%;">
  <thead>
    <tr>
      <th style="width: 33%;">
        <div style="text-align: center;"><span>Week</span></div>
      </th>
      <th style="width: 33%;">
        <div style="text-align: center;"><span>Milestone</span></div>
      </th>
      <th style="width: 33%;">
        <div style="text-align: center;"><span>Payment</span></div>
      </th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <div style="text-align: center;"><span>Week 1</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>Design phase</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>30%</span></div>
      </td>
    </tr>
    <tr>
      <td>
        <div style="text-align: center;"><span>Week 4</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>Customer approval</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>20%</span></div>
      </td>
    </tr>
    <tr>
      <td>
        <div style="text-align: center;"><span>Week 6</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>Implementation phase</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>40%</span></div>
      </td>
    </tr>
    <tr>
      <td>
        <div style="text-align: center;"><span>Week 16</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>Take-over</span></div>
      </td>
      <td>
        <div style="text-align: center;"><span>10%</span></div>
      </td>
    </tr>
  </tbody>
</table>
<br>
<p style="text-align: center;"><span style="color: grey; ">3. Drop</span><span>&nbsp;</span><span style="font-weight: 400; ">files</span></p>
<br>
<p style="text-align: center;"><span><a class="fr-file" href="911.pdf" target="_blank">911 Carrera.pdf</a></span></p>
<br>
<p style="text-align: center;"><span style="color: grey; ">4. Drop</span><span>&nbsp;</span><span style="font-weight: 400; ">images</span></p>
<br>
<p><span><img src="macbook.png" style="width: 546px;" class="fr-fic fr-dib fr-rounded"></span></p>
<br>
<p style="text-align: center;"><span style="color: grey; ">5. Attach</span><span>&nbsp;</span><span style="font-weight: 400; ">videos</span></p>
<br>
<p style="text-align: center;"><span style="font-weight: 400; "><span contenteditable="false" draggable="true" class="fr-video fr-deletable fr-fvc fr-dvb fr-draggable"><iframe src="https://www.youtube.com/embed/861Dt8Fy0IA?&wmode=opaque&rel=0" frameborder="0" allowfullscreen="" class="fr-draggable" style="width: 540px; height: 300px;"><span class="fr-mk" style="display: none;">&nbsp;</span></iframe></span></span></p>
`,
      value: null,
    },
  },
