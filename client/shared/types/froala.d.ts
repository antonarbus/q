...
declare module 'froala-editor' {
  export default class FroalaEditor {
    ...
    static DEFAULTS: Partial<FroalaOptions> | Record<string, any>
    static PLUGINS: (GenericObject<(editor: FroalaEditor) => CustomPlugin>) | any
    static MODULES: any | Record<string, any | Record<string, any>>
    ...
    static POPUP_TEMPLATES: Record<string, any>
  ...
  export type DefineIconParameters = {
    /**
  ...
  export type RegisterCommandParameters = {
    type: string
    // Button title.
    title: string
  ...
  export type CustomPlugin = Record<string, any | Record<string, any>>
  ...
  export type SpecialCharacterSet = {
    title: string
    char?: string
    list: Array<{
      char: string
  ...
  export type FroalaOptions = {
    ...
    // Aviary Editor
    aviaryKey: boolean
    aviaryOptions: Record<string, any>
    ...
    linkList: Array<GenericObject<string>>
  ...
  export type Image = {
    ...
    get(): object
    insert(link: string, sanitize: boolean, data: Record<string, any>, existingImage: any, response?: object): object
  ...
  export type FormatAttributes = Record<string, any>
  ...
  export type InlineStyle = {} & Apply<string>
  ...
  export type Link = {
    ...
    applyStyle(className: string): object
    get(): Element
    insert(href: string, text: string, attributes?: Record<string, any>): object
    remove(): object
    showInsertPopup(): void
  ...
  export type Popups = {
    _init(): void
    create(id: string, templateProperties: Record<string, any>): any
    get(id: string): any
  ...
  export type Quote = {} & Apply<string>
